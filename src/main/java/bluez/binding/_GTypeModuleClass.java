...
return (MemoryAddress __x0) -> {
                try {
                    return (int)_GTypeModuleClass.load$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress load$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModuleClass.load$VH.get(seg);
    }
    ...
    public static MemoryAddress load$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModuleClass.load$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    _GTypeModuleClass.unload$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle unload$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("unload"));
    ...
    public static MemoryAddress unload$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModuleClass.unload$VH.get(seg);
    }
    ...
    public static MemoryAddress unload$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModuleClass.unload$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress reserved1$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModuleClass.reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress reserved1$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModuleClass.reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress reserved2$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModuleClass.reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress reserved2$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModuleClass.reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    static final VarHandle reserved3$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("reserved3"));
    ...
    public static MemoryAddress reserved3$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModuleClass.reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress reserved3$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModuleClass.reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    static final VarHandle reserved4$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("reserved4"));
    ...
    public static MemoryAddress reserved4$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModuleClass.reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress reserved4$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModuleClass.reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
