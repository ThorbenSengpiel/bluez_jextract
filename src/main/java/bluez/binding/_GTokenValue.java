...
public class _GTokenValue {
    ...
    static final VarHandle v_symbol$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_symbol"));
    ...
    public static MemoryAddress v_symbol$get(MemorySegment seg) {
        return (MemoryAddress)_GTokenValue.v_symbol$VH.get(seg);
    }
    ...
    public static MemoryAddress v_symbol$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTokenValue.v_symbol$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle v_identifier$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_identifier"));
    ...
    public static MemoryAddress v_identifier$get(MemorySegment seg) {
        return (MemoryAddress)_GTokenValue.v_identifier$VH.get(seg);
    }
    ...
    public static MemoryAddress v_identifier$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTokenValue.v_identifier$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle v_binary$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_binary"));
    ...
    static final VarHandle v_octal$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_octal"));
    ...
    static final VarHandle v_int$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_int"));
    ...
    static final VarHandle v_int64$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_int64"));
    ...
    static final VarHandle v_hex$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_hex"));
    ...
    static final VarHandle v_string$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_string"));
    ...
    public static MemoryAddress v_string$get(MemorySegment seg) {
        return (MemoryAddress)_GTokenValue.v_string$VH.get(seg);
    }
    ...
    public static MemoryAddress v_string$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTokenValue.v_string$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle v_comment$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_comment"));
    ...
    public static MemoryAddress v_comment$get(MemorySegment seg) {
        return (MemoryAddress)_GTokenValue.v_comment$VH.get(seg);
    }
    ...
    public static MemoryAddress v_comment$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTokenValue.v_comment$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle v_char$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_char"));
    ...
    static final VarHandle v_error$VH = $union$LAYOUT.varHandle(PathElement.groupElement("v_error"));
