...
class constants$838 {
    ...
    static final MethodHandle GVfsFileLookupFunc$MH = RuntimeHelper.downcallHandle(
        constants$838.GVfsFileLookupFunc$FUNC, false
    );
    ...
    static final MethodHandle g_vfs_get_type$MH = RuntimeHelper.downcallHandle(
        "g_vfs_get_type",
        constants$838.g_vfs_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_vfs_is_active$MH = RuntimeHelper.downcallHandle(
        "g_vfs_is_active",
        constants$838.g_vfs_is_active$FUNC, false
    );
    ...
    static final MethodHandle g_vfs_get_file_for_path$MH = RuntimeHelper.downcallHandle(
        ...
        constants$838.g_vfs_get_file_for_path$FUNC, false
    );
    ...
    static final MethodHandle g_vfs_get_file_for_uri$MH = RuntimeHelper.downcallHandle(
        ...
        constants$838.g_vfs_get_file_for_uri$FUNC, false
    );
    ...
    static final MethodHandle g_vfs_get_supported_uri_schemes$MH = RuntimeHelper.downcallHandle(
        ...
        constants$838.g_vfs_get_supported_uri_schemes$FUNC, false
    );
}
