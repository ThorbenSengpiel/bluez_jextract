...
public class sigval {
    ...
    static final VarHandle sival_int$VH = $union$LAYOUT.varHandle(PathElement.groupElement("sival_int"));
    ...
    static final VarHandle sival_ptr$VH = $union$LAYOUT.varHandle(PathElement.groupElement("sival_ptr"));
    ...
    public static MemoryAddress sival_ptr$get(MemorySegment seg) {
        return (MemoryAddress)sigval.sival_ptr$VH.get(seg);
    }
    ...
    public static MemoryAddress sival_ptr$get(MemorySegment seg, long index) {
        return (MemoryAddress)sigval.sival_ptr$VH.get(seg.asSlice(index*sizeof()));
    }
