...
public class _GVariantBuilder {
    ...
    public static class u {
        ...
        public static class s {
            ...
            static final VarHandle partial_magic$VH = u$s$struct$LAYOUT.varHandle(PathElement.groupElement("partial_magic"));
            ...
            static final VarHandle type$VH = u$s$struct$LAYOUT.varHandle(PathElement.groupElement("type"));
            public static VarHandle type$VH() {
                return s.type$VH;
            }
            public static MemoryAddress type$get(MemorySegment seg) {
                return (MemoryAddress)s.type$VH.get(seg);
            }
            ...
            public static MemoryAddress type$get(MemorySegment seg, long index) {
                return (MemoryAddress)s.type$VH.get(seg.asSlice(index*sizeof()));
            }
