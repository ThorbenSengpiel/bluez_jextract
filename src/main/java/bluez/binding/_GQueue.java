...
public class _GQueue {
    ...
    static final VarHandle head$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("head"));
    public static VarHandle head$VH() {
        return _GQueue.head$VH;
    }
    public static MemoryAddress head$get(MemorySegment seg) {
        return (MemoryAddress)_GQueue.head$VH.get(seg);
    }
    ...
    public static MemoryAddress tail$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GQueue.tail$VH.get(seg.asSlice(index*sizeof()));
    }
