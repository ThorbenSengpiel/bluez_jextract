...
public class _GDBusInterfaceVTable {
    ...
    static final VarHandle method_call$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("method_call"));
    ...
    public static MemoryAddress method_call$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceVTable.method_call$VH.get(seg);
    }
    ...
    public static MemoryAddress method_call$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceVTable.method_call$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress get_property$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceVTable.get_property$VH.get(seg);
    }
    ...
    public static MemoryAddress get_property$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceVTable.get_property$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress set_property$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceVTable.set_property$VH.get(seg);
    }
    ...
    public static MemoryAddress set_property$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceVTable.set_property$VH.get(seg.asSlice(index*sizeof()));
    }
