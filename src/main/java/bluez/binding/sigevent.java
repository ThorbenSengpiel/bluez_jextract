...
public class sigevent {
    ...
    static final VarHandle sigev_signo$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("sigev_signo"));
    ...
    static final VarHandle sigev_notify$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("sigev_notify"));
    ...
    public static class _sigev_un {
        ...
        static final VarHandle _tid$VH = _sigev_un$union$LAYOUT.varHandle(PathElement.groupElement("_tid"));
...
return (MemorySegment __x0) -> {
                        try {
                            _sigev_thread._function$MH.invokeExact(symbol, __x0);
                        } catch (Throwable ex$) {
            ...
            static final VarHandle _function$VH = _sigev_un$_sigev_thread$struct$LAYOUT.varHandle(PathElement.groupElement("_function"));
            ...
            public static MemoryAddress _function$get(MemorySegment seg) {
                return (MemoryAddress)_sigev_thread._function$VH.get(seg);
            }
            ...
            public static MemoryAddress _function$get(MemorySegment seg, long index) {
                return (MemoryAddress)_sigev_thread._function$VH.get(seg.asSlice(index*sizeof()));
            }
            ...
            static final VarHandle _attribute$VH = _sigev_un$_sigev_thread$struct$LAYOUT.varHandle(PathElement.groupElement("_attribute"));
            ...
            public static MemoryAddress _attribute$get(MemorySegment seg) {
                return (MemoryAddress)_sigev_thread._attribute$VH.get(seg);
            }
            ...
            public static MemoryAddress _attribute$get(MemorySegment seg, long index) {
                return (MemoryAddress)_sigev_thread._attribute$VH.get(seg.asSlice(index*sizeof()));
            }
