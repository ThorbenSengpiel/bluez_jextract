...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GDBusInterfaceIface.get_info$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress get_info$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceIface.get_info$VH.get(seg);
    }
    ...
    public static MemoryAddress get_info$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceIface.get_info$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GDBusInterfaceIface.get_object$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress get_object$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceIface.get_object$VH.get(seg);
    }
    ...
    public static MemoryAddress get_object$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceIface.get_object$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    _GDBusInterfaceIface.set_object$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle set_object$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("set_object"));
    ...
    public static MemoryAddress set_object$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceIface.set_object$VH.get(seg);
    }
    ...
    public static MemoryAddress set_object$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceIface.set_object$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GDBusInterfaceIface.dup_object$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle dup_object$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("dup_object"));
    ...
    public static MemoryAddress dup_object$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceIface.dup_object$VH.get(seg);
    }
    ...
    public static MemoryAddress dup_object$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceIface.dup_object$VH.get(seg.asSlice(index*sizeof()));
    }
