...
public class _GSource {
    ...
    static final VarHandle callback_data$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("callback_data"));
    ...
    public static MemoryAddress callback_data$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.callback_data$VH.get(seg);
    }
    ...
    public static MemoryAddress callback_data$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.callback_data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle callback_funcs$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("callback_funcs"));
    ...
    public static MemoryAddress callback_funcs$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.callback_funcs$VH.get(seg);
    }
    ...
    public static MemoryAddress callback_funcs$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.callback_funcs$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle source_funcs$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("source_funcs"));
    ...
    public static MemoryAddress source_funcs$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.source_funcs$VH.get(seg);
    }
    ...
    public static MemoryAddress source_funcs$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.source_funcs$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle context$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("context"));
    public static VarHandle context$VH() {
        return _GSource.context$VH;
    }
    public static MemoryAddress context$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.context$VH.get(seg);
    }
    ...
    public static MemoryAddress context$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.context$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle priority$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("priority"));
    ...
    static final VarHandle source_id$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("source_id"));
    ...
    static final VarHandle poll_fds$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("poll_fds"));
    public static VarHandle poll_fds$VH() {
        return _GSource.poll_fds$VH;
    }
    public static MemoryAddress poll_fds$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.poll_fds$VH.get(seg);
    }
    ...
    public static MemoryAddress poll_fds$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.poll_fds$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle prev$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("prev"));
    public static VarHandle prev$VH() {
        return _GSource.prev$VH;
    }
    public static MemoryAddress prev$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.prev$VH.get(seg);
    }
    ...
    public static MemoryAddress prev$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.prev$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.next$VH.get(seg);
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.next$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (MemoryAddress)_GSource.priv$VH.get(seg);
    }
    ...
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSource.priv$VH.get(seg.asSlice(index*sizeof()));
    }
