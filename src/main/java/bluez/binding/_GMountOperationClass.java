...
public class _GMountOperationClass {
    ...
    public interface ask_password {
        ...
        void apply(MemoryAddress _x0, MemoryAddress _x1, MemoryAddress _x2, MemoryAddress _x3, int _x4);
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3, int __x4) -> {
                try {
                    _GMountOperationClass.ask_password$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3, __x4);
                } catch (Throwable ex$) {
    ...
    static final VarHandle ask_password$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ask_password"));
    ...
    public static MemoryAddress ask_password$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass.ask_password$VH.get(seg);
    }
    ...
    public static MemoryAddress ask_password$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass.ask_password$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    _GMountOperationClass.ask_question$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle ask_question$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ask_question"));
    ...
    public static MemoryAddress ask_question$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass.ask_question$VH.get(seg);
    }
    ...
    public static MemoryAddress ask_question$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass.ask_question$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, int __x1) -> {
                try {
                    _GMountOperationClass.reply$MH.invokeExact(symbol, (Addressable)__x0, __x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle reply$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("reply"));
    ...
    public static MemoryAddress reply$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass.reply$VH.get(seg);
    }
    ...
    public static MemoryAddress reply$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass.reply$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    _GMountOperationClass.aborted$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle aborted$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("aborted"));
    ...
    public static MemoryAddress aborted$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass.aborted$VH.get(seg);
    }
    ...
    public static MemoryAddress aborted$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass.aborted$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3) -> {
                try {
                    _GMountOperationClass.show_processes$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle show_processes$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("show_processes"));
    ...
    public static MemoryAddress show_processes$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass.show_processes$VH.get(seg);
    }
    ...
    public static MemoryAddress show_processes$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass.show_processes$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface show_unmount_progress {
        ...
        void apply(MemoryAddress _x0, MemoryAddress _x1, long _x2, long _x3);
...
return (MemoryAddress __x0, MemoryAddress __x1, long __x2, long __x3) -> {
                try {
                    _GMountOperationClass.show_unmount_progress$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, __x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle show_unmount_progress$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("show_unmount_progress"));
    ...
    public static MemoryAddress show_unmount_progress$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass.show_unmount_progress$VH.get(seg);
    }
    ...
    public static MemoryAddress show_unmount_progress$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass.show_unmount_progress$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved5$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved5$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved6$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved6$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved6$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved6$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved7$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved7$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved7$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved7$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved8$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved8$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved8$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved8$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved9$get(MemorySegment seg) {
        return (MemoryAddress)_GMountOperationClass._g_reserved9$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved9$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMountOperationClass._g_reserved9$VH.get(seg.asSlice(index*sizeof()));
    }
