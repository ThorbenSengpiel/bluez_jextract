...
public class _GString {
    ...
    static final VarHandle str$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("str"));
    public static VarHandle str$VH() {
        return _GString.str$VH;
    }
    public static MemoryAddress str$get(MemorySegment seg) {
        return (MemoryAddress)_GString.str$VH.get(seg);
    }
    ...
    public static MemoryAddress str$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GString.str$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle allocated_len$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("allocated_len"));
