...
class constants$102 {
    ...
    static final MethodHandle g_date_time_new_local$MH = RuntimeHelper.downcallHandle(
        ...
        constants$102.g_date_time_new_local$FUNC, false
    );
    ...
    static final MethodHandle g_date_time_new_utc$MH = RuntimeHelper.downcallHandle(
        "g_date_time_new_utc",
        constants$102.g_date_time_new_utc$FUNC, false
    );
    ...
    static final MethodHandle g_date_time_add$MH = RuntimeHelper.downcallHandle(
        "g_date_time_add",
        constants$102.g_date_time_add$FUNC, false
    );
    ...
    static final MethodHandle g_date_time_add_years$MH = RuntimeHelper.downcallHandle(
        ...
        constants$102.g_date_time_add_years$FUNC, false
    );
    ...
    static final MethodHandle g_date_time_add_months$MH = RuntimeHelper.downcallHandle(
        ...
        constants$102.g_date_time_add_months$FUNC, false
    );
    ...
    static final MethodHandle g_date_time_add_weeks$MH = RuntimeHelper.downcallHandle(
        ...
        constants$102.g_date_time_add_weeks$FUNC, false
    );
}
