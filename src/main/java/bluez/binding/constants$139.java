...
class constants$139 {
    ...
    static final MethodHandle g_direct_equal$MH = RuntimeHelper.downcallHandle(
        "g_direct_equal",
        constants$139.g_direct_equal$FUNC, false
    );
    ...
    static final MethodHandle g_hmac_new$MH = RuntimeHelper.downcallHandle(
        "g_hmac_new",
        constants$139.g_hmac_new$FUNC, false
    );
    ...
    static final MethodHandle g_hmac_copy$MH = RuntimeHelper.downcallHandle(
        "g_hmac_copy",
        constants$139.g_hmac_copy$FUNC, false
    );
    ...
    static final MethodHandle g_hmac_ref$MH = RuntimeHelper.downcallHandle(
        "g_hmac_ref",
        constants$139.g_hmac_ref$FUNC, false
    );
    ...
    static final MethodHandle g_hmac_unref$MH = RuntimeHelper.downcallHandle(
        "g_hmac_unref",
        constants$139.g_hmac_unref$FUNC, false
    );
    ...
    static final MethodHandle g_hmac_update$MH = RuntimeHelper.downcallHandle(
        "g_hmac_update",
        constants$139.g_hmac_update$FUNC, false
    );
}
