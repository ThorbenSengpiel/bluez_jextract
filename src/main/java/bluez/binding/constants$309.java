...
class constants$309 {
    ...
    static final MethodHandle g_assertion_message_cmpstr$MH = RuntimeHelper.downcallHandle(
        ...
        constants$309.g_assertion_message_cmpstr$FUNC, false
    );
    ...
    static final MethodHandle g_assertion_message_error$MH = RuntimeHelper.downcallHandle(
        ...
        constants$309.g_assertion_message_error$FUNC, false
    );
    ...
    static final MethodHandle g_test_add_vtable$MH = RuntimeHelper.downcallHandle(
        "g_test_add_vtable",
        constants$309.g_test_add_vtable$FUNC, false
    );
    static final  OfAddress g_test_config_vars$LAYOUT = Constants$root.C_POINTER$LAYOUT;
    static final VarHandle g_test_config_vars$VH = constants$309.g_test_config_vars$LAYOUT.varHandle();
    static final MemorySegment g_test_config_vars$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_test_config_vars", constants$309.g_test_config_vars$LAYOUT);
    ...
    static final MethodHandle g_test_log_type_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$309.g_test_log_type_name$FUNC, false
    );
    ...
    static final MethodHandle g_test_log_buffer_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$309.g_test_log_buffer_new$FUNC, false
    );
}
