...
public class _GDBusAnnotationInfo {
    ...
    public static MemoryAddress key$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusAnnotationInfo.key$VH.get(seg);
    }
    ...
    public static MemoryAddress key$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusAnnotationInfo.key$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress value$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusAnnotationInfo.value$VH.get(seg);
    }
    ...
    public static MemoryAddress value$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusAnnotationInfo.value$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusAnnotationInfo.annotations$VH.get(seg);
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusAnnotationInfo.annotations$VH.get(seg.asSlice(index*sizeof()));
    }
