...
public class _GParamSpecFlags {
    ...
    static final VarHandle flags_class$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("flags_class"));
    ...
    public static MemoryAddress flags_class$get(MemorySegment seg) {
        return (MemoryAddress)_GParamSpecFlags.flags_class$VH.get(seg);
    }
    ...
    public static MemoryAddress flags_class$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GParamSpecFlags.flags_class$VH.get(seg.asSlice(index*sizeof()));
    }
