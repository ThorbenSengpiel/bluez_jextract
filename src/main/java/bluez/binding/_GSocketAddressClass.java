...
return (MemoryAddress __x0) -> {
                try {
                    return (int)_GSocketAddressClass.get_family$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    static final VarHandle get_family$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_family"));
    ...
    public static MemoryAddress get_family$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketAddressClass.get_family$VH.get(seg);
    }
    ...
    public static MemoryAddress get_family$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketAddressClass.get_family$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (long)_GSocketAddressClass.get_native_size$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle get_native_size$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_native_size"));
    ...
    public static MemoryAddress get_native_size$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketAddressClass.get_native_size$VH.get(seg);
    }
    ...
    public static MemoryAddress get_native_size$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketAddressClass.get_native_size$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface to_native {
        ...
        int apply(MemoryAddress _x0, MemoryAddress _x1, long _x2, MemoryAddress _x3);
...
return (MemoryAddress __x0, MemoryAddress __x1, long __x2, MemoryAddress __x3) -> {
                try {
                    return (int)_GSocketAddressClass.to_native$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle to_native$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("to_native"));
    ...
    public static MemoryAddress to_native$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketAddressClass.to_native$VH.get(seg);
    }
    ...
    public static MemoryAddress to_native$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketAddressClass.to_native$VH.get(seg.asSlice(index*sizeof()));
    }
