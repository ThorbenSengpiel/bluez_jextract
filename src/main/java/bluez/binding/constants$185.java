...
class constants$185 {
    ...
    static final MethodHandle g_string_prepend_len$MH = RuntimeHelper.downcallHandle(
        ...
        constants$185.g_string_prepend_len$FUNC, false
    );
    ...
    static final MethodHandle g_string_insert$MH = RuntimeHelper.downcallHandle(
        "g_string_insert",
        constants$185.g_string_insert$FUNC, false
    );
    ...
    static final MethodHandle g_string_insert_c$MH = RuntimeHelper.downcallHandle(
        "g_string_insert_c",
        constants$185.g_string_insert_c$FUNC, false
    );
    ...
    static final MethodHandle g_string_insert_unichar$MH = RuntimeHelper.downcallHandle(
        ...
        constants$185.g_string_insert_unichar$FUNC, false
    );
    ...
    static final MethodHandle g_string_overwrite$MH = RuntimeHelper.downcallHandle(
        "g_string_overwrite",
        constants$185.g_string_overwrite$FUNC, false
    );
    ...
    static final MethodHandle g_string_overwrite_len$MH = RuntimeHelper.downcallHandle(
        ...
        constants$185.g_string_overwrite_len$FUNC, false
    );
}
