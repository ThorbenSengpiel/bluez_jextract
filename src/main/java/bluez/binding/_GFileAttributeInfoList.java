...
public class _GFileAttributeInfoList {
    ...
    static final VarHandle infos$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("infos"));
    ...
    public static MemoryAddress infos$get(MemorySegment seg) {
        return (MemoryAddress)_GFileAttributeInfoList.infos$VH.get(seg);
    }
    ...
    public static MemoryAddress infos$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileAttributeInfoList.infos$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle n_infos$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("n_infos"));
