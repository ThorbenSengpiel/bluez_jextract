...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (int)_GDBusObjectSkeletonClass.authorize_method$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
    ...
    static final VarHandle authorize_method$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("authorize_method"));
    ...
    public static MemoryAddress authorize_method$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusObjectSkeletonClass.authorize_method$VH.get(seg);
    }
    ...
    public static MemoryAddress authorize_method$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusObjectSkeletonClass.authorize_method$VH.get(seg.asSlice(index*sizeof()));
    }
