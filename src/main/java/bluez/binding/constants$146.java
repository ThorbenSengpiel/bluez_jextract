...
class constants$146 {
    ...
    static final MethodHandle g_hook_next_valid$MH = RuntimeHelper.downcallHandle(
        "g_hook_next_valid",
        constants$146.g_hook_next_valid$FUNC, false
    );
    ...
    static final MethodHandle g_hook_compare_ids$MH = RuntimeHelper.downcallHandle(
        "g_hook_compare_ids",
        constants$146.g_hook_compare_ids$FUNC, false
    );
    ...
    static final MethodHandle g_hook_list_invoke$MH = RuntimeHelper.downcallHandle(
        "g_hook_list_invoke",
        constants$146.g_hook_list_invoke$FUNC, false
    );
    ...
    static final MethodHandle g_hook_list_invoke_check$MH = RuntimeHelper.downcallHandle(
        ...
        constants$146.g_hook_list_invoke_check$FUNC, false
    );
    ...
    static final MethodHandle g_hook_list_marshal$MH = RuntimeHelper.downcallHandle(
        "g_hook_list_marshal",
        constants$146.g_hook_list_marshal$FUNC, false
    );
    ...
    static final MethodHandle g_hook_list_marshal_check$MH = RuntimeHelper.downcallHandle(
        ...
        constants$146.g_hook_list_marshal_check$FUNC, false
    );
}
