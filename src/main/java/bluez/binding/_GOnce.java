...
public class _GOnce {
    ...
    static final VarHandle status$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("status"));
    ...
    static final VarHandle retval$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("retval"));
    public static VarHandle retval$VH() {
        return _GOnce.retval$VH;
    }
    public static MemoryAddress retval$get(MemorySegment seg) {
        return (MemoryAddress)_GOnce.retval$VH.get(seg);
    }
    ...
    public static MemoryAddress retval$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GOnce.retval$VH.get(seg.asSlice(index*sizeof()));
    }
