...
public class _GDBusSubtreeVTable {
    ...
    public static MemoryAddress enumerate$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusSubtreeVTable.enumerate$VH.get(seg);
    }
    ...
    public static MemoryAddress enumerate$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusSubtreeVTable.enumerate$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle introspect$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("introspect"));
    ...
    public static MemoryAddress introspect$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusSubtreeVTable.introspect$VH.get(seg);
    }
    ...
    public static MemoryAddress introspect$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusSubtreeVTable.introspect$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress dispatch$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusSubtreeVTable.dispatch$VH.get(seg);
    }
    ...
    public static MemoryAddress dispatch$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusSubtreeVTable.dispatch$VH.get(seg.asSlice(index*sizeof()));
    }
