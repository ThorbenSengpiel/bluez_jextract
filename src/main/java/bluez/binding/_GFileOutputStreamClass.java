...
return (MemoryAddress __x0) -> {
                try {
                    return (long)_GFileOutputStreamClass.tell$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress tell$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.tell$VH.get(seg);
    }
    ...
    public static MemoryAddress tell$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.tell$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (int)_GFileOutputStreamClass.can_seek$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress can_seek$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.can_seek$VH.get(seg);
    }
    ...
    public static MemoryAddress can_seek$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.can_seek$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, long __x1, int __x2, MemoryAddress __x3, MemoryAddress __x4) -> {
                try {
                    return (int)_GFileOutputStreamClass.seek$MH.invokeExact(symbol, (Addressable)__x0, __x1, __x2, (Addressable)__x3, (Addressable)__x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress seek$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.seek$VH.get(seg);
    }
    ...
    public static MemoryAddress seek$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.seek$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (int)_GFileOutputStreamClass.can_truncate$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress can_truncate$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.can_truncate$VH.get(seg);
    }
    ...
    public static MemoryAddress can_truncate$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.can_truncate$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, long __x1, MemoryAddress __x2, MemoryAddress __x3) -> {
                try {
                    return (int)_GFileOutputStreamClass.truncate_fn$MH.invokeExact(symbol, (Addressable)__x0, __x1, (Addressable)__x2, (Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress truncate_fn$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.truncate_fn$VH.get(seg);
    }
    ...
    public static MemoryAddress truncate_fn$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.truncate_fn$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3) -> {
                try {
                    return (Addressable)(MemoryAddress)_GFileOutputStreamClass.query_info$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress query_info$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.query_info$VH.get(seg);
    }
    ...
    public static MemoryAddress query_info$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.query_info$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, int __x2, MemoryAddress __x3, MemoryAddress __x4, MemoryAddress __x5) -> {
                try {
                    _GFileOutputStreamClass.query_info_async$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3, (Addressable)__x4, (Addressable)__x5);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress query_info_async$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.query_info_async$VH.get(seg);
    }
    ...
    public static MemoryAddress query_info_async$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.query_info_async$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (Addressable)(MemoryAddress)_GFileOutputStreamClass.query_info_finish$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress query_info_finish$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.query_info_finish$VH.get(seg);
    }
    ...
    public static MemoryAddress query_info_finish$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.query_info_finish$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GFileOutputStreamClass.get_etag$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle get_etag$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_etag"));
    ...
    public static MemoryAddress get_etag$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass.get_etag$VH.get(seg);
    }
    ...
    public static MemoryAddress get_etag$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass.get_etag$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved5$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFileOutputStreamClass._g_reserved5$VH.get(seg.asSlice(index*sizeof()));
    }
