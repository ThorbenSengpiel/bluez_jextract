...
return (MemoryAddress __x0) -> {
                try {
                    _GSourceCallbackFuncs.ref$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    static final VarHandle ref$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ref"));
    public static VarHandle ref$VH() {
        return _GSourceCallbackFuncs.ref$VH;
    }
    public static MemoryAddress ref$get(MemorySegment seg) {
        return (MemoryAddress)_GSourceCallbackFuncs.ref$VH.get(seg);
    }
    ...
    public static MemoryAddress ref$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSourceCallbackFuncs.ref$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    _GSourceCallbackFuncs.unref$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle unref$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("unref"));
    ...
    public static MemoryAddress unref$get(MemorySegment seg) {
        return (MemoryAddress)_GSourceCallbackFuncs.unref$VH.get(seg);
    }
    ...
    public static MemoryAddress unref$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSourceCallbackFuncs.unref$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3) -> {
                try {
                    _GSourceCallbackFuncs.get$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle get$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get"));
    public static VarHandle get$VH() {
        return _GSourceCallbackFuncs.get$VH;
    }
    public static MemoryAddress get$get(MemorySegment seg) {
        return (MemoryAddress)_GSourceCallbackFuncs.get$VH.get(seg);
    }
    ...
    public static MemoryAddress get$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSourceCallbackFuncs.get$VH.get(seg.asSlice(index*sizeof()));
    }
