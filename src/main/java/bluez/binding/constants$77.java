...
class constants$77 {
    ...
    static final MethodHandle g_bookmark_file_set_visited$MH = RuntimeHelper.downcallHandle(
        ...
        constants$77.g_bookmark_file_set_visited$FUNC, false
    );
    ...
    static final MethodHandle g_bookmark_file_get_visited$MH = RuntimeHelper.downcallHandle(
        ...
        constants$77.g_bookmark_file_get_visited$FUNC, false
    );
    ...
    static final MethodHandle g_bookmark_file_has_item$MH = RuntimeHelper.downcallHandle(
        ...
        constants$77.g_bookmark_file_has_item$FUNC, false
    );
    ...
    static final MethodHandle g_bookmark_file_get_size$MH = RuntimeHelper.downcallHandle(
        ...
        constants$77.g_bookmark_file_get_size$FUNC, false
    );
    ...
    static final MethodHandle g_bookmark_file_get_uris$MH = RuntimeHelper.downcallHandle(
        ...
        constants$77.g_bookmark_file_get_uris$FUNC, false
    );
    ...
    static final MethodHandle g_bookmark_file_remove_group$MH = RuntimeHelper.downcallHandle(
        ...
        constants$77.g_bookmark_file_remove_group$FUNC, false
    );
}
