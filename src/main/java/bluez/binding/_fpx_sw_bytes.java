...
public class _fpx_sw_bytes {
    ...
    static final VarHandle magic1$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("magic1"));
    ...
    static final VarHandle extended_size$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("extended_size"));
    ...
    static final VarHandle xstate_bv$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("xstate_bv"));
    ...
    static final VarHandle xstate_size$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("xstate_size"));
