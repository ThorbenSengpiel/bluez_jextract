...
public class _GTypeInterface {
    ...
    static final VarHandle g_type$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("g_type"));
    ...
    static final VarHandle g_instance_type$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("g_instance_type"));
