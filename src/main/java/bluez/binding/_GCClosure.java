...
public class _GCClosure {
    ...
    static final VarHandle callback$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("callback"));
    ...
    public static MemoryAddress callback$get(MemorySegment seg) {
        return (MemoryAddress)_GCClosure.callback$VH.get(seg);
    }
    ...
    public static MemoryAddress callback$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GCClosure.callback$VH.get(seg.asSlice(index*sizeof()));
    }
