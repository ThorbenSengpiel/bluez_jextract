...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    return (Addressable)(MemoryAddress)_GTlsPasswordClass.get_value$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress get_value$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsPasswordClass.get_value$VH.get(seg);
    }
    ...
    public static MemoryAddress get_value$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsPasswordClass.get_value$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface set_value {
        ...
        void apply(MemoryAddress _x0, MemoryAddress _x1, long _x2, MemoryAddress _x3);
...
return (MemoryAddress __x0, MemoryAddress __x1, long __x2, MemoryAddress __x3) -> {
                try {
                    _GTlsPasswordClass.set_value$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle set_value$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("set_value"));
    ...
    public static MemoryAddress set_value$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsPasswordClass.set_value$VH.get(seg);
    }
    ...
    public static MemoryAddress set_value$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsPasswordClass.set_value$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GTlsPasswordClass.get_default_warning$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle get_default_warning$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_default_warning"));
    ...
    public static MemoryAddress get_default_warning$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsPasswordClass.get_default_warning$VH.get(seg);
    }
    ...
    public static MemoryAddress get_default_warning$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsPasswordClass.get_default_warning$VH.get(seg.asSlice(index*sizeof()));
    }
