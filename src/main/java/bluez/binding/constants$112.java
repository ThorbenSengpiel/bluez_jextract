...
class constants$112 {
    ...
    static final MethodHandle g_setenv$MH = RuntimeHelper.downcallHandle(
        "g_setenv",
        constants$112.g_setenv$FUNC, false
    );
    ...
    static final MethodHandle g_unsetenv$MH = RuntimeHelper.downcallHandle(
        "g_unsetenv",
        constants$112.g_unsetenv$FUNC, false
    );
    ...
    static final MethodHandle g_listenv$MH = RuntimeHelper.downcallHandle(
        "g_listenv",
        constants$112.g_listenv$FUNC, false
    );
    ...
    static final MethodHandle g_get_environ$MH = RuntimeHelper.downcallHandle(
        "g_get_environ",
        constants$112.g_get_environ$FUNC, false
    );
    ...
    static final MethodHandle g_environ_getenv$MH = RuntimeHelper.downcallHandle(
        "g_environ_getenv",
        constants$112.g_environ_getenv$FUNC, false
    );
    ...
    static final MethodHandle g_environ_setenv$MH = RuntimeHelper.downcallHandle(
        "g_environ_setenv",
        constants$112.g_environ_setenv$FUNC, false
    );
}
