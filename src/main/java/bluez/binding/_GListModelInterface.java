...
return (MemoryAddress __x0) -> {
                try {
                    return (long)_GListModelInterface.get_item_type$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    static final VarHandle get_item_type$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_item_type"));
    ...
    public static MemoryAddress get_item_type$get(MemorySegment seg) {
        return (MemoryAddress)_GListModelInterface.get_item_type$VH.get(seg);
    }
    ...
    public static MemoryAddress get_item_type$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GListModelInterface.get_item_type$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (int)_GListModelInterface.get_n_items$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress get_n_items$get(MemorySegment seg) {
        return (MemoryAddress)_GListModelInterface.get_n_items$VH.get(seg);
    }
    ...
    public static MemoryAddress get_n_items$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GListModelInterface.get_n_items$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, int __x1) -> {
                try {
                    return (Addressable)(MemoryAddress)_GListModelInterface.get_item$MH.invokeExact(symbol, (Addressable)__x0, __x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle get_item$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_item"));
    ...
    public static MemoryAddress get_item$get(MemorySegment seg) {
        return (MemoryAddress)_GListModelInterface.get_item$VH.get(seg);
    }
    ...
    public static MemoryAddress get_item$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GListModelInterface.get_item$VH.get(seg.asSlice(index*sizeof()));
    }
