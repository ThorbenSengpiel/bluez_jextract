...
public class _GScannerConfig {
    ...
    static final VarHandle cset_skip_characters$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("cset_skip_characters"));
    ...
    public static MemoryAddress cset_skip_characters$get(MemorySegment seg) {
        return (MemoryAddress)_GScannerConfig.cset_skip_characters$VH.get(seg);
    }
    ...
    public static MemoryAddress cset_skip_characters$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScannerConfig.cset_skip_characters$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle cset_identifier_first$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("cset_identifier_first"));
    ...
    public static MemoryAddress cset_identifier_first$get(MemorySegment seg) {
        return (MemoryAddress)_GScannerConfig.cset_identifier_first$VH.get(seg);
    }
    ...
    public static MemoryAddress cset_identifier_first$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScannerConfig.cset_identifier_first$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle cset_identifier_nth$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("cset_identifier_nth"));
    ...
    public static MemoryAddress cset_identifier_nth$get(MemorySegment seg) {
        return (MemoryAddress)_GScannerConfig.cset_identifier_nth$VH.get(seg);
    }
    ...
    public static MemoryAddress cset_identifier_nth$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScannerConfig.cset_identifier_nth$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle cpair_comment_single$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("cpair_comment_single"));
    ...
    public static MemoryAddress cpair_comment_single$get(MemorySegment seg) {
        return (MemoryAddress)_GScannerConfig.cpair_comment_single$VH.get(seg);
    }
    ...
    public static MemoryAddress cpair_comment_single$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScannerConfig.cpair_comment_single$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle padding_dummy$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("padding_dummy"));
