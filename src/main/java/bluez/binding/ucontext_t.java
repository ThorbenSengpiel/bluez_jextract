...
public class ucontext_t {
    ...
    static final VarHandle uc_flags$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("uc_flags"));
    ...
    static final VarHandle uc_link$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("uc_link"));
    public static VarHandle uc_link$VH() {
        return ucontext_t.uc_link$VH;
    }
    public static MemoryAddress uc_link$get(MemorySegment seg) {
        return (MemoryAddress)ucontext_t.uc_link$VH.get(seg);
    }
    ...
    public static MemoryAddress uc_link$get(MemorySegment seg, long index) {
        return (MemoryAddress)ucontext_t.uc_link$VH.get(seg.asSlice(index*sizeof()));
    }
