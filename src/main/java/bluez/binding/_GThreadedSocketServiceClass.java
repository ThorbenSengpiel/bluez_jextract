...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (int)_GThreadedSocketServiceClass.run$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
    ...
    static final VarHandle run$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("run"));
    ...
    public static MemoryAddress run$get(MemorySegment seg) {
        return (MemoryAddress)_GThreadedSocketServiceClass.run$VH.get(seg);
    }
    ...
    public static MemoryAddress run$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GThreadedSocketServiceClass.run$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved5$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GThreadedSocketServiceClass._g_reserved5$VH.get(seg.asSlice(index*sizeof()));
    }
