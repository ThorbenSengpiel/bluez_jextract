...
class constants$506 {
    ...
    static final MethodHandle g_app_info_get_supported_types$MH = RuntimeHelper.downcallHandle(
        ...
        constants$506.g_app_info_get_supported_types$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_can_delete$MH = RuntimeHelper.downcallHandle(
        ...
        constants$506.g_app_info_can_delete$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_delete$MH = RuntimeHelper.downcallHandle(
        "g_app_info_delete",
        constants$506.g_app_info_delete$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_set_as_last_used_for_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$506.g_app_info_set_as_last_used_for_type$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_all$MH = RuntimeHelper.downcallHandle(
        "g_app_info_get_all",
        constants$506.g_app_info_get_all$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_all_for_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$506.g_app_info_get_all_for_type$FUNC, false
    );
}
