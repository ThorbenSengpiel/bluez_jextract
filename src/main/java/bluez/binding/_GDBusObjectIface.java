...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GDBusObjectIface.get_object_path$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress get_object_path$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusObjectIface.get_object_path$VH.get(seg);
    }
    ...
    public static MemoryAddress get_object_path$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusObjectIface.get_object_path$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GDBusObjectIface.get_interfaces$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle get_interfaces$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_interfaces"));
    ...
    public static MemoryAddress get_interfaces$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusObjectIface.get_interfaces$VH.get(seg);
    }
    ...
    public static MemoryAddress get_interfaces$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusObjectIface.get_interfaces$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    return (Addressable)(MemoryAddress)_GDBusObjectIface.get_interface$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress get_interface$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusObjectIface.get_interface$VH.get(seg);
    }
    ...
    public static MemoryAddress get_interface$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusObjectIface.get_interface$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    _GDBusObjectIface.interface_added$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress interface_added$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusObjectIface.interface_added$VH.get(seg);
    }
    ...
    public static MemoryAddress interface_added$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusObjectIface.interface_added$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    _GDBusObjectIface.interface_removed$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress interface_removed$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusObjectIface.interface_removed$VH.get(seg);
    }
    ...
    public static MemoryAddress interface_removed$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusObjectIface.interface_removed$VH.get(seg.asSlice(index*sizeof()));
    }
