...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    return (Addressable)(MemoryAddress)_GActionMapInterface.lookup_action$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
    ...
    static final VarHandle lookup_action$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("lookup_action"));
    ...
    public static MemoryAddress lookup_action$get(MemorySegment seg) {
        return (MemoryAddress)_GActionMapInterface.lookup_action$VH.get(seg);
    }
    ...
    public static MemoryAddress lookup_action$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GActionMapInterface.lookup_action$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    _GActionMapInterface.add_action$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle add_action$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("add_action"));
    ...
    public static MemoryAddress add_action$get(MemorySegment seg) {
        return (MemoryAddress)_GActionMapInterface.add_action$VH.get(seg);
    }
    ...
    public static MemoryAddress add_action$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GActionMapInterface.add_action$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    _GActionMapInterface.remove_action$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle remove_action$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("remove_action"));
    ...
    public static MemoryAddress remove_action$get(MemorySegment seg) {
        return (MemoryAddress)_GActionMapInterface.remove_action$VH.get(seg);
    }
    ...
    public static MemoryAddress remove_action$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GActionMapInterface.remove_action$VH.get(seg.asSlice(index*sizeof()));
    }
