...
public class _GParamSpecValueArray {
    ...
    static final VarHandle element_spec$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("element_spec"));
    ...
    public static MemoryAddress element_spec$get(MemorySegment seg) {
        return (MemoryAddress)_GParamSpecValueArray.element_spec$VH.get(seg);
    }
    ...
    public static MemoryAddress element_spec$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GParamSpecValueArray.element_spec$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle fixed_n_elements$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("fixed_n_elements"));
