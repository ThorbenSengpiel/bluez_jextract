...
class constants$840 {
    ...
    static final MethodHandle g_volume_get_name$MH = RuntimeHelper.downcallHandle(
        "g_volume_get_name",
        constants$840.g_volume_get_name$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_icon$MH = RuntimeHelper.downcallHandle(
        "g_volume_get_icon",
        constants$840.g_volume_get_icon$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_symbolic_icon$MH = RuntimeHelper.downcallHandle(
        ...
        constants$840.g_volume_get_symbolic_icon$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_uuid$MH = RuntimeHelper.downcallHandle(
        "g_volume_get_uuid",
        constants$840.g_volume_get_uuid$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_drive$MH = RuntimeHelper.downcallHandle(
        "g_volume_get_drive",
        constants$840.g_volume_get_drive$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_mount$MH = RuntimeHelper.downcallHandle(
        "g_volume_get_mount",
        constants$840.g_volume_get_mount$FUNC, false
    );
}
