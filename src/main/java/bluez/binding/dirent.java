...
public class dirent {
    ...
    static final VarHandle d_ino$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("d_ino"));
    ...
    static final VarHandle d_off$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("d_off"));
    ...
    static final VarHandle d_reclen$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("d_reclen"));
    ...
    static final VarHandle d_type$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("d_type"));
