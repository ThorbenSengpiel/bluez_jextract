...
class constants$503 {
    ...
    static final MethodHandle g_app_info_get_name$MH = RuntimeHelper.downcallHandle(
        "g_app_info_get_name",
        constants$503.g_app_info_get_name$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_display_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$503.g_app_info_get_display_name$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_description$MH = RuntimeHelper.downcallHandle(
        ...
        constants$503.g_app_info_get_description$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_executable$MH = RuntimeHelper.downcallHandle(
        ...
        constants$503.g_app_info_get_executable$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_commandline$MH = RuntimeHelper.downcallHandle(
        ...
        constants$503.g_app_info_get_commandline$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_icon$MH = RuntimeHelper.downcallHandle(
        "g_app_info_get_icon",
        constants$503.g_app_info_get_icon$FUNC, false
    );
}
