...
public class _GTypeInstance {
    ...
    static final VarHandle g_class$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("g_class"));
    ...
    public static MemoryAddress g_class$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeInstance.g_class$VH.get(seg);
    }
    ...
    public static MemoryAddress g_class$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeInstance.g_class$VH.get(seg.asSlice(index*sizeof()));
    }
