...
public class _GTypeModule {
    ...
    static final VarHandle use_count$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("use_count"));
    ...
    static final VarHandle type_infos$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("type_infos"));
    ...
    public static MemoryAddress type_infos$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModule.type_infos$VH.get(seg);
    }
    ...
    public static MemoryAddress type_infos$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModule.type_infos$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle interface_infos$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("interface_infos"));
    ...
    public static MemoryAddress interface_infos$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModule.interface_infos$VH.get(seg);
    }
    ...
    public static MemoryAddress interface_infos$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModule.interface_infos$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (MemoryAddress)_GTypeModule.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTypeModule.name$VH.get(seg.asSlice(index*sizeof()));
    }
