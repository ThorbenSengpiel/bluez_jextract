...
public class _GDBusNodeInfo {
    ...
    static final VarHandle path$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("path"));
    public static VarHandle path$VH() {
        return _GDBusNodeInfo.path$VH;
    }
    public static MemoryAddress path$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusNodeInfo.path$VH.get(seg);
    }
    ...
    public static MemoryAddress path$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusNodeInfo.path$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle interfaces$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("interfaces"));
    ...
    public static MemoryAddress interfaces$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusNodeInfo.interfaces$VH.get(seg);
    }
    ...
    public static MemoryAddress interfaces$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusNodeInfo.interfaces$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle nodes$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("nodes"));
    public static VarHandle nodes$VH() {
        return _GDBusNodeInfo.nodes$VH;
    }
    public static MemoryAddress nodes$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusNodeInfo.nodes$VH.get(seg);
    }
    ...
    public static MemoryAddress nodes$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusNodeInfo.nodes$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusNodeInfo.annotations$VH.get(seg);
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusNodeInfo.annotations$VH.get(seg.asSlice(index*sizeof()));
    }
