...
public class _fpstate {
    ...
    static final VarHandle cwd$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("cwd"));
    ...
    static final VarHandle swd$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("swd"));
    ...
    static final VarHandle ftw$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ftw"));
    ...
    static final VarHandle fop$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("fop"));
    ...
    static final VarHandle rdp$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("rdp"));
    ...
    static final VarHandle mxcsr$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("mxcsr"));
    ...
    static final VarHandle mxcr_mask$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("mxcr_mask"));
