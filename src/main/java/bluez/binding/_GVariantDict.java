...
public class _GVariantDict {
    ...
    public static class u {
        ...
        public static class s {
            ...
            static final VarHandle asv$VH = u$s$struct$LAYOUT.varHandle(PathElement.groupElement("asv"));
            public static VarHandle asv$VH() {
                return s.asv$VH;
            }
            public static MemoryAddress asv$get(MemorySegment seg) {
                return (MemoryAddress)s.asv$VH.get(seg);
            }
            ...
            public static MemoryAddress asv$get(MemorySegment seg, long index) {
                return (MemoryAddress)s.asv$VH.get(seg.asSlice(index*sizeof()));
            }
