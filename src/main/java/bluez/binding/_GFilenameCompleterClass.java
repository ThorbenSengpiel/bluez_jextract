...
return (MemoryAddress __x0) -> {
                try {
                    _GFilenameCompleterClass.got_completion_data$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    static final VarHandle got_completion_data$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("got_completion_data"));
    ...
    public static MemoryAddress got_completion_data$get(MemorySegment seg) {
        return (MemoryAddress)_GFilenameCompleterClass.got_completion_data$VH.get(seg);
    }
    ...
    public static MemoryAddress got_completion_data$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFilenameCompleterClass.got_completion_data$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg) {
        return (MemoryAddress)_GFilenameCompleterClass._g_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFilenameCompleterClass._g_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg) {
        return (MemoryAddress)_GFilenameCompleterClass._g_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFilenameCompleterClass._g_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg) {
        return (MemoryAddress)_GFilenameCompleterClass._g_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFilenameCompleterClass._g_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
