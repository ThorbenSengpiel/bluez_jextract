...
class constants$818 {
    ...
    static final MethodHandle g_task_propagate_boolean$MH = RuntimeHelper.downcallHandle(
        ...
        constants$818.g_task_propagate_boolean$FUNC, false
    );
    ...
    static final MethodHandle g_task_propagate_int$MH = RuntimeHelper.downcallHandle(
        ...
        constants$818.g_task_propagate_int$FUNC, false
    );
    ...
    static final MethodHandle g_task_propagate_value$MH = RuntimeHelper.downcallHandle(
        ...
        constants$818.g_task_propagate_value$FUNC, false
    );
    ...
    static final MethodHandle g_task_had_error$MH = RuntimeHelper.downcallHandle(
        "g_task_had_error",
        constants$818.g_task_had_error$FUNC, false
    );
    ...
    static final MethodHandle g_task_get_completed$MH = RuntimeHelper.downcallHandle(
        ...
        constants$818.g_task_get_completed$FUNC, false
    );
    ...
    static final MethodHandle g_tcp_connection_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$818.g_tcp_connection_get_type$FUNC, false
    );
}
