...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3, MemoryAddress __x4, MemoryAddress __x5) -> {
                try {
                    _GMarkupParser.start_element$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3, (Addressable)__x4, (Addressable)__x5);
                } catch (Throwable ex$) {
    ...
    static final VarHandle start_element$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("start_element"));
    ...
    public static MemoryAddress start_element$get(MemorySegment seg) {
        return (MemoryAddress)_GMarkupParser.start_element$VH.get(seg);
    }
    ...
    public static MemoryAddress start_element$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMarkupParser.start_element$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3) -> {
                try {
                    _GMarkupParser.end_element$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle end_element$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("end_element"));
    ...
    public static MemoryAddress end_element$get(MemorySegment seg) {
        return (MemoryAddress)_GMarkupParser.end_element$VH.get(seg);
    }
    ...
    public static MemoryAddress end_element$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMarkupParser.end_element$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface text {
        ...
        void apply(MemoryAddress _x0, MemoryAddress _x1, long _x2, MemoryAddress _x3, MemoryAddress _x4);
...
return (MemoryAddress __x0, MemoryAddress __x1, long __x2, MemoryAddress __x3, MemoryAddress __x4) -> {
                try {
                    _GMarkupParser.text$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3, (Addressable)__x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress text$get(MemorySegment seg) {
        return (MemoryAddress)_GMarkupParser.text$VH.get(seg);
    }
    ...
    public static MemoryAddress text$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMarkupParser.text$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, long __x2, MemoryAddress __x3, MemoryAddress __x4) -> {
                try {
                    _GMarkupParser.passthrough$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3, (Addressable)__x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle passthrough$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("passthrough"));
    ...
    public static MemoryAddress passthrough$get(MemorySegment seg) {
        return (MemoryAddress)_GMarkupParser.passthrough$VH.get(seg);
    }
    ...
    public static MemoryAddress passthrough$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMarkupParser.passthrough$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    _GMarkupParser.error$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress error$get(MemorySegment seg) {
        return (MemoryAddress)_GMarkupParser.error$VH.get(seg);
    }
    ...
    public static MemoryAddress error$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMarkupParser.error$VH.get(seg.asSlice(index*sizeof()));
    }
