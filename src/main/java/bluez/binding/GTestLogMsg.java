...
public class GTestLogMsg {
    ...
    static final VarHandle log_type$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("log_type"));
    ...
    static final VarHandle n_strings$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("n_strings"));
    ...
    static final VarHandle strings$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("strings"));
    public static VarHandle strings$VH() {
        return GTestLogMsg.strings$VH;
    }
    public static MemoryAddress strings$get(MemorySegment seg) {
        return (MemoryAddress)GTestLogMsg.strings$VH.get(seg);
    }
    ...
    public static MemoryAddress strings$get(MemorySegment seg, long index) {
        return (MemoryAddress)GTestLogMsg.strings$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle n_nums$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("n_nums"));
    ...
    static final VarHandle nums$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("nums"));
    public static VarHandle nums$VH() {
        return GTestLogMsg.nums$VH;
    }
    public static MemoryAddress nums$get(MemorySegment seg) {
        return (MemoryAddress)GTestLogMsg.nums$VH.get(seg);
    }
    ...
    public static MemoryAddress nums$get(MemorySegment seg, long index) {
        return (MemoryAddress)GTestLogMsg.nums$VH.get(seg.asSlice(index*sizeof()));
    }
