...
class constants$537 {
    ...
    static final MethodHandle g_cancellable_reset$MH = RuntimeHelper.downcallHandle(
        "g_cancellable_reset",
        constants$537.g_cancellable_reset$FUNC, false
    );
    ...
    static final MethodHandle g_cancellable_connect$MH = RuntimeHelper.downcallHandle(
        ...
        constants$537.g_cancellable_connect$FUNC, false
    );
    ...
    static final MethodHandle g_cancellable_disconnect$MH = RuntimeHelper.downcallHandle(
        ...
        constants$537.g_cancellable_disconnect$FUNC, false
    );
    ...
    static final MethodHandle g_cancellable_cancel$MH = RuntimeHelper.downcallHandle(
        ...
        constants$537.g_cancellable_cancel$FUNC, false
    );
    ...
    static final MethodHandle g_converter_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$537.g_converter_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_converter_convert$MH = RuntimeHelper.downcallHandle(
        "g_converter_convert",
        constants$537.g_converter_convert$FUNC, false
    );
}
