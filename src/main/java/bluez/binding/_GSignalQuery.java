...
public class _GSignalQuery {
    ...
    static final VarHandle signal_name$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("signal_name"));
    ...
    public static MemoryAddress signal_name$get(MemorySegment seg) {
        return (MemoryAddress)_GSignalQuery.signal_name$VH.get(seg);
    }
    ...
    public static MemoryAddress signal_name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSignalQuery.signal_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle itype$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("itype"));
    ...
    static final VarHandle signal_flags$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("signal_flags"));
    ...
    static final VarHandle return_type$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("return_type"));
    ...
    static final VarHandle n_params$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("n_params"));
    ...
    static final VarHandle param_types$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("param_types"));
    ...
    public static MemoryAddress param_types$get(MemorySegment seg) {
        return (MemoryAddress)_GSignalQuery.param_types$VH.get(seg);
    }
    ...
    public static MemoryAddress param_types$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSignalQuery.param_types$VH.get(seg.asSlice(index*sizeof()));
    }
