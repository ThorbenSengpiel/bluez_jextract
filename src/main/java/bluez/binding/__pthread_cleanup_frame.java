...
return (MemoryAddress __x0) -> {
                try {
                    __pthread_cleanup_frame.__cancel_routine$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    static final VarHandle __cancel_routine$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("__cancel_routine"));
    ...
    public static MemoryAddress __cancel_routine$get(MemorySegment seg) {
        return (MemoryAddress)__pthread_cleanup_frame.__cancel_routine$VH.get(seg);
    }
    ...
    public static MemoryAddress __cancel_routine$get(MemorySegment seg, long index) {
        return (MemoryAddress)__pthread_cleanup_frame.__cancel_routine$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle __cancel_arg$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("__cancel_arg"));
    ...
    public static MemoryAddress __cancel_arg$get(MemorySegment seg) {
        return (MemoryAddress)__pthread_cleanup_frame.__cancel_arg$VH.get(seg);
    }
    ...
    public static MemoryAddress __cancel_arg$get(MemorySegment seg, long index) {
        return (MemoryAddress)__pthread_cleanup_frame.__cancel_arg$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle __do_it$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("__do_it"));
    ...
    static final VarHandle __cancel_type$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("__cancel_type"));
