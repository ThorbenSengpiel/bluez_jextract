...
return (MemoryAddress __x0) -> {
                try {
                    _pthread_cleanup_buffer.__routine$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress __routine$get(MemorySegment seg) {
        return (MemoryAddress)_pthread_cleanup_buffer.__routine$VH.get(seg);
    }
    ...
    public static MemoryAddress __routine$get(MemorySegment seg, long index) {
        return (MemoryAddress)_pthread_cleanup_buffer.__routine$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress __arg$get(MemorySegment seg) {
        return (MemoryAddress)_pthread_cleanup_buffer.__arg$VH.get(seg);
    }
    ...
    public static MemoryAddress __arg$get(MemorySegment seg, long index) {
        return (MemoryAddress)_pthread_cleanup_buffer.__arg$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle __canceltype$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("__canceltype"));
    ...
    public static MemoryAddress __prev$get(MemorySegment seg) {
        return (MemoryAddress)_pthread_cleanup_buffer.__prev$VH.get(seg);
    }
    ...
    public static MemoryAddress __prev$get(MemorySegment seg, long index) {
        return (MemoryAddress)_pthread_cleanup_buffer.__prev$VH.get(seg.asSlice(index*sizeof()));
    }
