...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GInetAddressClass.to_string$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress to_string$get(MemorySegment seg) {
        return (MemoryAddress)_GInetAddressClass.to_string$VH.get(seg);
    }
    ...
    public static MemoryAddress to_string$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GInetAddressClass.to_string$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GInetAddressClass.to_bytes$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle to_bytes$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("to_bytes"));
    ...
    public static MemoryAddress to_bytes$get(MemorySegment seg) {
        return (MemoryAddress)_GInetAddressClass.to_bytes$VH.get(seg);
    }
    ...
    public static MemoryAddress to_bytes$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GInetAddressClass.to_bytes$VH.get(seg.asSlice(index*sizeof()));
    }
