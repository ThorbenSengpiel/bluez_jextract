...
class constants$253 {
    ...
    static final MethodHandle g_rand_new_with_seed$MH = RuntimeHelper.downcallHandle(
        ...
        constants$253.g_rand_new_with_seed$FUNC, false
    );
    ...
    static final MethodHandle g_rand_new_with_seed_array$MH = RuntimeHelper.downcallHandle(
        ...
        constants$253.g_rand_new_with_seed_array$FUNC, false
    );
    ...
    static final MethodHandle g_rand_new$MH = RuntimeHelper.downcallHandle(
        "g_rand_new",
        constants$253.g_rand_new$FUNC, false
    );
    ...
    static final MethodHandle g_rand_free$MH = RuntimeHelper.downcallHandle(
        "g_rand_free",
        constants$253.g_rand_free$FUNC, false
    );
    ...
    static final MethodHandle g_rand_copy$MH = RuntimeHelper.downcallHandle(
        "g_rand_copy",
        constants$253.g_rand_copy$FUNC, false
    );
    ...
    static final MethodHandle g_rand_set_seed$MH = RuntimeHelper.downcallHandle(
        "g_rand_set_seed",
        constants$253.g_rand_set_seed$FUNC, false
    );
}
