...
public class _GDBusMethodInfo {
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusMethodInfo.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusMethodInfo.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle in_args$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("in_args"));
    ...
    public static MemoryAddress in_args$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusMethodInfo.in_args$VH.get(seg);
    }
    ...
    public static MemoryAddress in_args$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusMethodInfo.in_args$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle out_args$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("out_args"));
    ...
    public static MemoryAddress out_args$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusMethodInfo.out_args$VH.get(seg);
    }
    ...
    public static MemoryAddress out_args$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusMethodInfo.out_args$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusMethodInfo.annotations$VH.get(seg);
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusMethodInfo.annotations$VH.get(seg.asSlice(index*sizeof()));
    }
