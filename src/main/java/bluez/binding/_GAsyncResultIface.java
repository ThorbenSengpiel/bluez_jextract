...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GAsyncResultIface.get_user_data$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    static final VarHandle get_user_data$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_user_data"));
    ...
    public static MemoryAddress get_user_data$get(MemorySegment seg) {
        return (MemoryAddress)_GAsyncResultIface.get_user_data$VH.get(seg);
    }
    ...
    public static MemoryAddress get_user_data$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GAsyncResultIface.get_user_data$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GAsyncResultIface.get_source_object$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle get_source_object$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_source_object"));
    ...
    public static MemoryAddress get_source_object$get(MemorySegment seg) {
        return (MemoryAddress)_GAsyncResultIface.get_source_object$VH.get(seg);
    }
    ...
    public static MemoryAddress get_source_object$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GAsyncResultIface.get_source_object$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    return (int)_GAsyncResultIface.is_tagged$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle is_tagged$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("is_tagged"));
    ...
    public static MemoryAddress is_tagged$get(MemorySegment seg) {
        return (MemoryAddress)_GAsyncResultIface.is_tagged$VH.get(seg);
    }
    ...
    public static MemoryAddress is_tagged$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GAsyncResultIface.is_tagged$VH.get(seg.asSlice(index*sizeof()));
    }
