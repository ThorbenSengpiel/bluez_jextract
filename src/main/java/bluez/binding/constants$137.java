...
class constants$137 {
    ...
    static final MethodHandle g_hash_table_iter_steal$MH = RuntimeHelper.downcallHandle(
        ...
        constants$137.g_hash_table_iter_steal$FUNC, false
    );
    ...
    static final MethodHandle g_hash_table_ref$MH = RuntimeHelper.downcallHandle(
        "g_hash_table_ref",
        constants$137.g_hash_table_ref$FUNC, false
    );
    ...
    static final MethodHandle g_hash_table_unref$MH = RuntimeHelper.downcallHandle(
        "g_hash_table_unref",
        constants$137.g_hash_table_unref$FUNC, false
    );
    ...
    static final MethodHandle g_str_equal$MH = RuntimeHelper.downcallHandle(
        "g_str_equal",
        constants$137.g_str_equal$FUNC, false
    );
    ...
    static final MethodHandle g_str_hash$MH = RuntimeHelper.downcallHandle(
        "g_str_hash",
        constants$137.g_str_hash$FUNC, false
    );
    ...
    static final MethodHandle g_int_equal$MH = RuntimeHelper.downcallHandle(
        "g_int_equal",
        constants$137.g_int_equal$FUNC, false
    );
}
