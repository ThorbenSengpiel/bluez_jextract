...
public class sigstack {
    ...
    public static MemoryAddress ss_sp$get(MemorySegment seg) {
        return (MemoryAddress)sigstack.ss_sp$VH.get(seg);
    }
    ...
    public static MemoryAddress ss_sp$get(MemorySegment seg, long index) {
        return (MemoryAddress)sigstack.ss_sp$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle ss_onstack$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ss_onstack"));
