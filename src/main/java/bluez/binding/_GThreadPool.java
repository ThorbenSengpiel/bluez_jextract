...
public class _GThreadPool {
    ...
    public static MemoryAddress func$get(MemorySegment seg) {
        return (MemoryAddress)_GThreadPool.func$VH.get(seg);
    }
    ...
    public static MemoryAddress func$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GThreadPool.func$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress user_data$get(MemorySegment seg) {
        return (MemoryAddress)_GThreadPool.user_data$VH.get(seg);
    }
    ...
    public static MemoryAddress user_data$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GThreadPool.user_data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle exclusive$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("exclusive"));
