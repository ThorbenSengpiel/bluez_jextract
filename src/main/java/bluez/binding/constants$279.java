...
class constants$279 {
    ...
    static final MethodHandle g_slice_copy$MH = RuntimeHelper.downcallHandle(
        "g_slice_copy",
        constants$279.g_slice_copy$FUNC, false
    );
    ...
    static final MethodHandle g_slice_free1$MH = RuntimeHelper.downcallHandle(
        "g_slice_free1",
        constants$279.g_slice_free1$FUNC, false
    );
    ...
    static final MethodHandle g_slice_free_chain_with_offset$MH = RuntimeHelper.downcallHandle(
        ...
        constants$279.g_slice_free_chain_with_offset$FUNC, false
    );
    ...
    static final MethodHandle g_slice_set_config$MH = RuntimeHelper.downcallHandle(
        "g_slice_set_config",
        constants$279.g_slice_set_config$FUNC, false
    );
    ...
    static final MethodHandle g_slice_get_config$MH = RuntimeHelper.downcallHandle(
        "g_slice_get_config",
        constants$279.g_slice_get_config$FUNC, false
    );
    ...
    static final MethodHandle g_slice_get_config_state$MH = RuntimeHelper.downcallHandle(
        ...
        constants$279.g_slice_get_config_state$FUNC, false
    );
}
