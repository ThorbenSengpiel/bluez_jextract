...
public class GTestLogBuffer {
    ...
    public static MemoryAddress data$get(MemorySegment seg) {
        return (MemoryAddress)GTestLogBuffer.data$VH.get(seg);
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg, long index) {
        return (MemoryAddress)GTestLogBuffer.data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle msgs$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("msgs"));
    public static VarHandle msgs$VH() {
        return GTestLogBuffer.msgs$VH;
    }
    public static MemoryAddress msgs$get(MemorySegment seg) {
        return (MemoryAddress)GTestLogBuffer.msgs$VH.get(seg);
    }
    ...
    public static MemoryAddress msgs$get(MemorySegment seg, long index) {
        return (MemoryAddress)GTestLogBuffer.msgs$VH.get(seg.asSlice(index*sizeof()));
    }
