...
public class _GStaticRWLock {
    ...
    static final VarHandle read_cond$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("read_cond"));
    ...
    public static MemoryAddress read_cond$get(MemorySegment seg) {
        return (MemoryAddress)_GStaticRWLock.read_cond$VH.get(seg);
    }
    ...
    public static MemoryAddress read_cond$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GStaticRWLock.read_cond$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle write_cond$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("write_cond"));
    ...
    public static MemoryAddress write_cond$get(MemorySegment seg) {
        return (MemoryAddress)_GStaticRWLock.write_cond$VH.get(seg);
    }
    ...
    public static MemoryAddress write_cond$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GStaticRWLock.write_cond$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle read_counter$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("read_counter"));
    ...
    static final VarHandle have_writer$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("have_writer"));
    ...
    static final VarHandle want_to_read$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("want_to_read"));
    ...
    static final VarHandle want_to_write$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("want_to_write"));
