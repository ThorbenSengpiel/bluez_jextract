...
public class _GDBusInterfaceInfo {
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceInfo.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceInfo.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle methods$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("methods"));
    ...
    public static MemoryAddress methods$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceInfo.methods$VH.get(seg);
    }
    ...
    public static MemoryAddress methods$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceInfo.methods$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle signals$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("signals"));
    ...
    public static MemoryAddress signals$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceInfo.signals$VH.get(seg);
    }
    ...
    public static MemoryAddress signals$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceInfo.signals$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle properties$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("properties"));
    ...
    public static MemoryAddress properties$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceInfo.properties$VH.get(seg);
    }
    ...
    public static MemoryAddress properties$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceInfo.properties$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle annotations$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("annotations"));
    ...
    public static MemoryAddress annotations$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusInterfaceInfo.annotations$VH.get(seg);
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusInterfaceInfo.annotations$VH.get(seg.asSlice(index*sizeof()));
    }
