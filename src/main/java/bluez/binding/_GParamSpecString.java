...
public class _GParamSpecString {
    ...
    public static MemoryAddress default_value$get(MemorySegment seg) {
        return (MemoryAddress)_GParamSpecString.default_value$VH.get(seg);
    }
    ...
    public static MemoryAddress default_value$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GParamSpecString.default_value$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle cset_first$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("cset_first"));
    ...
    public static MemoryAddress cset_first$get(MemorySegment seg) {
        return (MemoryAddress)_GParamSpecString.cset_first$VH.get(seg);
    }
    ...
    public static MemoryAddress cset_first$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GParamSpecString.cset_first$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle cset_nth$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("cset_nth"));
    ...
    public static MemoryAddress cset_nth$get(MemorySegment seg) {
        return (MemoryAddress)_GParamSpecString.cset_nth$VH.get(seg);
    }
    ...
    public static MemoryAddress cset_nth$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GParamSpecString.cset_nth$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle substitutor$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("substitutor"));
