...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    _GSettingsClass.writable_changed$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
    ...
    static final VarHandle writable_changed$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("writable_changed"));
    ...
    public static MemoryAddress writable_changed$get(MemorySegment seg) {
        return (MemoryAddress)_GSettingsClass.writable_changed$VH.get(seg);
    }
    ...
    public static MemoryAddress writable_changed$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSettingsClass.writable_changed$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    _GSettingsClass.changed$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress changed$get(MemorySegment seg) {
        return (MemoryAddress)_GSettingsClass.changed$VH.get(seg);
    }
    ...
    public static MemoryAddress changed$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSettingsClass.changed$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, int __x1) -> {
                try {
                    return (int)_GSettingsClass.writable_change_event$MH.invokeExact(symbol, (Addressable)__x0, __x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle writable_change_event$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("writable_change_event"));
    ...
    public static MemoryAddress writable_change_event$get(MemorySegment seg) {
        return (MemoryAddress)_GSettingsClass.writable_change_event$VH.get(seg);
    }
    ...
    public static MemoryAddress writable_change_event$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSettingsClass.writable_change_event$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, int __x2) -> {
                try {
                    return (int)_GSettingsClass.change_event$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle change_event$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("change_event"));
    ...
    public static MemoryAddress change_event$get(MemorySegment seg) {
        return (MemoryAddress)_GSettingsClass.change_event$VH.get(seg);
    }
    ...
    public static MemoryAddress change_event$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSettingsClass.change_event$VH.get(seg.asSlice(index*sizeof()));
    }
