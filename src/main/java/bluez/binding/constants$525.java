...
class constants$525 {
    ...
    static final MethodHandle g_filter_input_stream_get_base_stream$MH = RuntimeHelper.downcallHandle(
        ...
        constants$525.g_filter_input_stream_get_base_stream$FUNC, false
    );
    ...
    static final MethodHandle g_filter_input_stream_get_close_base_stream$MH = RuntimeHelper.downcallHandle(
        ...
        constants$525.g_filter_input_stream_get_close_base_stream$FUNC, false
    );
    ...
    static final MethodHandle g_filter_input_stream_set_close_base_stream$MH = RuntimeHelper.downcallHandle(
        ...
        constants$525.g_filter_input_stream_set_close_base_stream$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_input_stream_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$525.g_buffered_input_stream_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_input_stream_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$525.g_buffered_input_stream_new$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_input_stream_new_sized$MH = RuntimeHelper.downcallHandle(
        ...
        constants$525.g_buffered_input_stream_new_sized$FUNC, false
    );
}
