...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3) -> {
                try {
                    return (int)_GTlsInteractionClass.ask_password$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress ask_password$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsInteractionClass.ask_password$VH.get(seg);
    }
    ...
    public static MemoryAddress ask_password$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsInteractionClass.ask_password$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3, MemoryAddress __x4) -> {
                try {
                    _GTlsInteractionClass.ask_password_async$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3, (Addressable)__x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle ask_password_async$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ask_password_async"));
    ...
    public static MemoryAddress ask_password_async$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsInteractionClass.ask_password_async$VH.get(seg);
    }
    ...
    public static MemoryAddress ask_password_async$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsInteractionClass.ask_password_async$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (int)_GTlsInteractionClass.ask_password_finish$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle ask_password_finish$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ask_password_finish"));
    ...
    public static MemoryAddress ask_password_finish$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsInteractionClass.ask_password_finish$VH.get(seg);
    }
    ...
    public static MemoryAddress ask_password_finish$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsInteractionClass.ask_password_finish$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, int __x2, MemoryAddress __x3, MemoryAddress __x4) -> {
                try {
                    return (int)_GTlsInteractionClass.request_certificate$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3, (Addressable)__x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle request_certificate$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("request_certificate"));
    ...
    public static MemoryAddress request_certificate$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsInteractionClass.request_certificate$VH.get(seg);
    }
    ...
    public static MemoryAddress request_certificate$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsInteractionClass.request_certificate$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, int __x2, MemoryAddress __x3, MemoryAddress __x4, MemoryAddress __x5) -> {
                try {
                    _GTlsInteractionClass.request_certificate_async$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3, (Addressable)__x4, (Addressable)__x5);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle request_certificate_async$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("request_certificate_async"));
    ...
    public static MemoryAddress request_certificate_async$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsInteractionClass.request_certificate_async$VH.get(seg);
    }
    ...
    public static MemoryAddress request_certificate_async$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsInteractionClass.request_certificate_async$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (int)_GTlsInteractionClass.request_certificate_finish$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle request_certificate_finish$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("request_certificate_finish"));
    ...
    public static MemoryAddress request_certificate_finish$get(MemorySegment seg) {
        return (MemoryAddress)_GTlsInteractionClass.request_certificate_finish$VH.get(seg);
    }
    ...
    public static MemoryAddress request_certificate_finish$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GTlsInteractionClass.request_certificate_finish$VH.get(seg.asSlice(index*sizeof()));
    }
