...
class constants$116 {
    ...
    static final MethodHandle g_mkdir_with_parents$MH = RuntimeHelper.downcallHandle(
        ...
        constants$116.g_mkdir_with_parents$FUNC, false
    );
    ...
    static final MethodHandle g_path_is_absolute$MH = RuntimeHelper.downcallHandle(
        "g_path_is_absolute",
        constants$116.g_path_is_absolute$FUNC, false
    );
    ...
    static final MethodHandle g_path_skip_root$MH = RuntimeHelper.downcallHandle(
        "g_path_skip_root",
        constants$116.g_path_skip_root$FUNC, false
    );
    ...
    static final MethodHandle g_basename$MH = RuntimeHelper.downcallHandle(
        "g_basename",
        constants$116.g_basename$FUNC, false
    );
    ...
    static final MethodHandle g_get_current_dir$MH = RuntimeHelper.downcallHandle(
        "g_get_current_dir",
        constants$116.g_get_current_dir$FUNC, false
    );
    ...
    static final MethodHandle g_path_get_basename$MH = RuntimeHelper.downcallHandle(
        "g_path_get_basename",
        constants$116.g_path_get_basename$FUNC, false
    );
}
