...
return (MemoryAddress __x0, long __x1, MemoryAddress __x2, MemoryAddress __x3) -> {
                try {
                    return (long)_GBufferedInputStreamClass.fill$MH.invokeExact(symbol, (Addressable)__x0, __x1, (Addressable)__x2, (Addressable)__x3);
                } catch (Throwable ex$) {
    ...
    static final VarHandle fill$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("fill"));
    ...
    public static MemoryAddress fill$get(MemorySegment seg) {
        return (MemoryAddress)_GBufferedInputStreamClass.fill$VH.get(seg);
    }
    ...
    public static MemoryAddress fill$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GBufferedInputStreamClass.fill$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, long __x1, int __x2, MemoryAddress __x3, MemoryAddress __x4, MemoryAddress __x5) -> {
                try {
                    _GBufferedInputStreamClass.fill_async$MH.invokeExact(symbol, (Addressable)__x0, __x1, __x2, (Addressable)__x3, (Addressable)__x4, (Addressable)__x5);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle fill_async$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("fill_async"));
    ...
    public static MemoryAddress fill_async$get(MemorySegment seg) {
        return (MemoryAddress)_GBufferedInputStreamClass.fill_async$VH.get(seg);
    }
    ...
    public static MemoryAddress fill_async$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GBufferedInputStreamClass.fill_async$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (long)_GBufferedInputStreamClass.fill_finish$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle fill_finish$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("fill_finish"));
    ...
    public static MemoryAddress fill_finish$get(MemorySegment seg) {
        return (MemoryAddress)_GBufferedInputStreamClass.fill_finish$VH.get(seg);
    }
    ...
    public static MemoryAddress fill_finish$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GBufferedInputStreamClass.fill_finish$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved5$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GBufferedInputStreamClass._g_reserved5$VH.get(seg.asSlice(index*sizeof()));
    }
