...
class constants$502 {
    ...
    static final MethodHandle g_action_map_add_action_entries$MH = RuntimeHelper.downcallHandle(
        ...
        constants$502.g_action_map_add_action_entries$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_type$MH = RuntimeHelper.downcallHandle(
        "g_app_info_get_type",
        constants$502.g_app_info_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_create_from_commandline$MH = RuntimeHelper.downcallHandle(
        ...
        constants$502.g_app_info_create_from_commandline$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_dup$MH = RuntimeHelper.downcallHandle(
        "g_app_info_dup",
        constants$502.g_app_info_dup$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_equal$MH = RuntimeHelper.downcallHandle(
        "g_app_info_equal",
        constants$502.g_app_info_equal$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_id$MH = RuntimeHelper.downcallHandle(
        "g_app_info_get_id",
        constants$502.g_app_info_get_id$FUNC, false
    );
}
