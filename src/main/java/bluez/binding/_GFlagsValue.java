...
public class _GFlagsValue {
    ...
    static final VarHandle value_name$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("value_name"));
    ...
    public static MemoryAddress value_name$get(MemorySegment seg) {
        return (MemoryAddress)_GFlagsValue.value_name$VH.get(seg);
    }
    ...
    public static MemoryAddress value_name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFlagsValue.value_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle value_nick$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("value_nick"));
    ...
    public static MemoryAddress value_nick$get(MemorySegment seg) {
        return (MemoryAddress)_GFlagsValue.value_nick$VH.get(seg);
    }
    ...
    public static MemoryAddress value_nick$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GFlagsValue.value_nick$VH.get(seg.asSlice(index*sizeof()));
    }
