...
return (MemoryAddress __x0) -> {
                try {
                    _GSocketListenerClass.changed$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress changed$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketListenerClass.changed$VH.get(seg);
    }
    ...
    public static MemoryAddress changed$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketListenerClass.changed$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, int __x1, MemoryAddress __x2) -> {
                try {
                    _GSocketListenerClass.event$MH.invokeExact(symbol, (Addressable)__x0, __x1, (Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress event$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketListenerClass.event$VH.get(seg);
    }
    ...
    public static MemoryAddress event$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketListenerClass.event$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved5$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved5$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved6$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved6$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved6$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketListenerClass._g_reserved6$VH.get(seg.asSlice(index*sizeof()));
    }
