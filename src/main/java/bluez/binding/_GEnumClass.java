...
public class _GEnumClass {
    ...
    static final VarHandle minimum$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("minimum"));
    ...
    static final VarHandle maximum$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("maximum"));
    ...
    public static MemoryAddress values$get(MemorySegment seg) {
        return (MemoryAddress)_GEnumClass.values$VH.get(seg);
    }
    ...
    public static MemoryAddress values$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GEnumClass.values$VH.get(seg.asSlice(index*sizeof()));
    }
