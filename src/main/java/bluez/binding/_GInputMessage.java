...
public class _GInputMessage {
    ...
    static final VarHandle address$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("address"));
    ...
    public static MemoryAddress address$get(MemorySegment seg) {
        return (MemoryAddress)_GInputMessage.address$VH.get(seg);
    }
    ...
    public static MemoryAddress address$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GInputMessage.address$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle vectors$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("vectors"));
    ...
    public static MemoryAddress vectors$get(MemorySegment seg) {
        return (MemoryAddress)_GInputMessage.vectors$VH.get(seg);
    }
    ...
    public static MemoryAddress vectors$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GInputMessage.vectors$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle num_vectors$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("num_vectors"));
    ...
    static final VarHandle bytes_received$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("bytes_received"));
    ...
    static final VarHandle control_messages$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("control_messages"));
    ...
    public static MemoryAddress control_messages$get(MemorySegment seg) {
        return (MemoryAddress)_GInputMessage.control_messages$VH.get(seg);
    }
    ...
    public static MemoryAddress control_messages$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GInputMessage.control_messages$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle num_control_messages$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("num_control_messages"));
    ...
    public static MemoryAddress num_control_messages$get(MemorySegment seg) {
        return (MemoryAddress)_GInputMessage.num_control_messages$VH.get(seg);
    }
    ...
    public static MemoryAddress num_control_messages$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GInputMessage.num_control_messages$VH.get(seg.asSlice(index*sizeof()));
    }
