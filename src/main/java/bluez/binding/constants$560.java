...
class constants$560 {
    ...
    static final MethodHandle ftruncate$MH = RuntimeHelper.downcallHandle(
        "ftruncate",
        constants$560.ftruncate$FUNC, false
    );
    ...
    static final MethodHandle syscall$MH = RuntimeHelper.downcallHandle(
        "syscall",
        constants$560.syscall$FUNC, true
    );
    ...
    static final MethodHandle lockf$MH = RuntimeHelper.downcallHandle(
        "lockf",
        constants$560.lockf$FUNC, false
    );
    ...
    static final MethodHandle fdatasync$MH = RuntimeHelper.downcallHandle(
        "fdatasync",
        constants$560.fdatasync$FUNC, false
    );
}
