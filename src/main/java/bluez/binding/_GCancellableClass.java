...
return (MemoryAddress __x0) -> {
                try {
                    _GCancellableClass.cancelled$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    static final VarHandle cancelled$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("cancelled"));
    ...
    public static MemoryAddress cancelled$get(MemorySegment seg) {
        return (MemoryAddress)_GCancellableClass.cancelled$VH.get(seg);
    }
    ...
    public static MemoryAddress cancelled$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GCancellableClass.cancelled$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg) {
        return (MemoryAddress)_GCancellableClass._g_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GCancellableClass._g_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg) {
        return (MemoryAddress)_GCancellableClass._g_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GCancellableClass._g_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg) {
        return (MemoryAddress)_GCancellableClass._g_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GCancellableClass._g_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg) {
        return (MemoryAddress)_GCancellableClass._g_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GCancellableClass._g_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg) {
        return (MemoryAddress)_GCancellableClass._g_reserved5$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved5$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GCancellableClass._g_reserved5$VH.get(seg.asSlice(index*sizeof()));
    }
