...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (int)_GInitableIface.init$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
    ...
    static final VarHandle init$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("init"));
    public static VarHandle init$VH() {
        return _GInitableIface.init$VH;
    }
    public static MemoryAddress init$get(MemorySegment seg) {
        return (MemoryAddress)_GInitableIface.init$VH.get(seg);
    }
    ...
    public static MemoryAddress init$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GInitableIface.init$VH.get(seg.asSlice(index*sizeof()));
    }
