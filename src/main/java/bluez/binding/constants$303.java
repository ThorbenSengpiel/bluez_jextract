...
class constants$303 {
    ...
    static final MethodHandle g_test_subprocess$MH = RuntimeHelper.downcallHandle(
        "g_test_subprocess",
        constants$303.g_test_subprocess$FUNC, false
    );
    ...
    static final MethodHandle g_test_run$MH = RuntimeHelper.downcallHandle(
        "g_test_run",
        constants$303.g_test_run$FUNC, false
    );
    ...
    static final MethodHandle g_test_add_func$MH = RuntimeHelper.downcallHandle(
        "g_test_add_func",
        constants$303.g_test_add_func$FUNC, false
    );
    ...
    static final MethodHandle g_test_add_data_func$MH = RuntimeHelper.downcallHandle(
        ...
        constants$303.g_test_add_data_func$FUNC, false
    );
    ...
    static final MethodHandle g_test_add_data_func_full$MH = RuntimeHelper.downcallHandle(
        ...
        constants$303.g_test_add_data_func_full$FUNC, false
    );
    ...
    static final MethodHandle g_test_fail$MH = RuntimeHelper.downcallHandle(
        "g_test_fail",
        constants$303.g_test_fail$FUNC, false
    );
}
