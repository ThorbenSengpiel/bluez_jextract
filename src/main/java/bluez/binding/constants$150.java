...
class constants$150 {
    ...
    static final MethodHandle g_slist_concat$MH = RuntimeHelper.downcallHandle(
        "g_slist_concat",
        constants$150.g_slist_concat$FUNC, false
    );
    ...
    static final MethodHandle g_slist_remove$MH = RuntimeHelper.downcallHandle(
        "g_slist_remove",
        constants$150.g_slist_remove$FUNC, false
    );
    ...
    static final MethodHandle g_slist_remove_all$MH = RuntimeHelper.downcallHandle(
        "g_slist_remove_all",
        constants$150.g_slist_remove_all$FUNC, false
    );
    ...
    static final MethodHandle g_slist_remove_link$MH = RuntimeHelper.downcallHandle(
        "g_slist_remove_link",
        constants$150.g_slist_remove_link$FUNC, false
    );
    ...
    static final MethodHandle g_slist_delete_link$MH = RuntimeHelper.downcallHandle(
        "g_slist_delete_link",
        constants$150.g_slist_delete_link$FUNC, false
    );
    ...
    static final MethodHandle g_slist_reverse$MH = RuntimeHelper.downcallHandle(
        "g_slist_reverse",
        constants$150.g_slist_reverse$FUNC, false
    );
}
