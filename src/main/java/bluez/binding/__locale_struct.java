...
public class __locale_struct {
    ...
    static final VarHandle __ctype_b$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("__ctype_b"));
    ...
    static final VarHandle __ctype_tolower$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("__ctype_tolower"));
    ...
    static final VarHandle __ctype_toupper$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("__ctype_toupper"));
