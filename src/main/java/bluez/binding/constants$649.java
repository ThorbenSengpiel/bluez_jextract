...
class constants$649 {
    ...
    static final MethodHandle g_file_set_attribute_byte_string$MH = RuntimeHelper.downcallHandle(
        ...
        constants$649.g_file_set_attribute_byte_string$FUNC, false
    );
    ...
    static final MethodHandle g_file_set_attribute_uint32$MH = RuntimeHelper.downcallHandle(
        ...
        constants$649.g_file_set_attribute_uint32$FUNC, false
    );
    ...
    static final MethodHandle g_file_set_attribute_int32$MH = RuntimeHelper.downcallHandle(
        ...
        constants$649.g_file_set_attribute_int32$FUNC, false
    );
    ...
    static final MethodHandle g_file_set_attribute_uint64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$649.g_file_set_attribute_uint64$FUNC, false
    );
    ...
    static final MethodHandle g_file_set_attribute_int64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$649.g_file_set_attribute_int64$FUNC, false
    );
    ...
    static final MethodHandle g_file_mount_enclosing_volume$MH = RuntimeHelper.downcallHandle(
        ...
        constants$649.g_file_mount_enclosing_volume$FUNC, false
    );
}
