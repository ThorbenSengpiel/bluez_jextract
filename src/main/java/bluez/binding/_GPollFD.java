...
public class _GPollFD {
    ...
    static final VarHandle fd$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("fd"));
    ...
    static final VarHandle events$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("events"));
    ...
    static final VarHandle revents$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("revents"));
