...
public class _GMutex {
    ...
    static final VarHandle p$VH = $union$LAYOUT.varHandle(PathElement.groupElement("p"));
    public static VarHandle p$VH() {
        return _GMutex.p$VH;
    }
    public static MemoryAddress p$get(MemorySegment seg) {
        return (MemoryAddress)_GMutex.p$VH.get(seg);
    }
    ...
    public static MemoryAddress p$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMutex.p$VH.get(seg.asSlice(index*sizeof()));
    }
