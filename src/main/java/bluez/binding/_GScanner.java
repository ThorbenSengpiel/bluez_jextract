...
public class _GScanner {
    ...
    public static MemoryAddress user_data$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.user_data$VH.get(seg);
    }
    ...
    public static MemoryAddress user_data$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.user_data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle max_parse_errors$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("max_parse_errors"));
    ...
    static final VarHandle parse_errors$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("parse_errors"));
    ...
    static final VarHandle input_name$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("input_name"));
    ...
    public static MemoryAddress input_name$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.input_name$VH.get(seg);
    }
    ...
    public static MemoryAddress input_name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.input_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress qdata$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.qdata$VH.get(seg);
    }
    ...
    public static MemoryAddress qdata$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.qdata$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle config$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("config"));
    public static VarHandle config$VH() {
        return _GScanner.config$VH;
    }
    public static MemoryAddress config$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.config$VH.get(seg);
    }
    ...
    public static MemoryAddress config$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.config$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle token$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("token"));
    ...
    static final VarHandle line$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("line"));
    ...
    static final VarHandle position$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("position"));
    ...
    static final VarHandle next_token$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("next_token"));
    ...
    static final VarHandle next_line$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("next_line"));
    ...
    static final VarHandle next_position$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("next_position"));
    ...
    static final VarHandle symbol_table$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("symbol_table"));
    ...
    public static MemoryAddress symbol_table$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.symbol_table$VH.get(seg);
    }
    ...
    public static MemoryAddress symbol_table$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.symbol_table$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle input_fd$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("input_fd"));
    ...
    public static MemoryAddress text$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.text$VH.get(seg);
    }
    ...
    public static MemoryAddress text$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.text$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void text$set(MemorySegment seg, long index, MemoryAddress x) {
        _GScanner.text$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle text_end$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("text_end"));
    ...
    public static MemoryAddress text_end$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.text_end$VH.get(seg);
    }
    ...
    public static MemoryAddress text_end$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.text_end$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle buffer$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("buffer"));
    public static VarHandle buffer$VH() {
        return _GScanner.buffer$VH;
    }
    public static MemoryAddress buffer$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.buffer$VH.get(seg);
    }
    ...
    public static MemoryAddress buffer$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.buffer$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle scope_id$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("scope_id"));
    ...
    static final VarHandle msg_handler$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("msg_handler"));
    ...
    public static MemoryAddress msg_handler$get(MemorySegment seg) {
        return (MemoryAddress)_GScanner.msg_handler$VH.get(seg);
    }
    ...
    public static MemoryAddress msg_handler$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GScanner.msg_handler$VH.get(seg.asSlice(index*sizeof()));
    }
