...
public class _GError {
    ...
    static final VarHandle domain$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("domain"));
    ...
    static final VarHandle code$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("code"));
    ...
    static final VarHandle message$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("message"));
    ...
    public static MemoryAddress message$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GError.message$VH.get(seg.asSlice(index*sizeof()));
    }
