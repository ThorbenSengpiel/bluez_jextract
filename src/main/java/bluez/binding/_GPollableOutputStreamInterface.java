...
return (MemoryAddress __x0) -> {
                try {
                    return (int)_GPollableOutputStreamInterface.can_poll$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress can_poll$get(MemorySegment seg) {
        return (MemoryAddress)_GPollableOutputStreamInterface.can_poll$VH.get(seg);
    }
    ...
    public static MemoryAddress can_poll$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GPollableOutputStreamInterface.can_poll$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (int)_GPollableOutputStreamInterface.is_writable$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle is_writable$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("is_writable"));
    ...
    public static MemoryAddress is_writable$get(MemorySegment seg) {
        return (MemoryAddress)_GPollableOutputStreamInterface.is_writable$VH.get(seg);
    }
    ...
    public static MemoryAddress is_writable$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GPollableOutputStreamInterface.is_writable$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    return (Addressable)(MemoryAddress)_GPollableOutputStreamInterface.create_source$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress create_source$get(MemorySegment seg) {
        return (MemoryAddress)_GPollableOutputStreamInterface.create_source$VH.get(seg);
    }
    ...
    public static MemoryAddress create_source$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GPollableOutputStreamInterface.create_source$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, long __x2, MemoryAddress __x3) -> {
                try {
                    return (long)_GPollableOutputStreamInterface.write_nonblocking$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle write_nonblocking$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("write_nonblocking"));
    ...
    public static MemoryAddress write_nonblocking$get(MemorySegment seg) {
        return (MemoryAddress)_GPollableOutputStreamInterface.write_nonblocking$VH.get(seg);
    }
    ...
    public static MemoryAddress write_nonblocking$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GPollableOutputStreamInterface.write_nonblocking$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, long __x2, MemoryAddress __x3, MemoryAddress __x4) -> {
                try {
                    return (int)_GPollableOutputStreamInterface.writev_nonblocking$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, __x2, (Addressable)__x3, (Addressable)__x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle writev_nonblocking$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("writev_nonblocking"));
    ...
    public static MemoryAddress writev_nonblocking$get(MemorySegment seg) {
        return (MemoryAddress)_GPollableOutputStreamInterface.writev_nonblocking$VH.get(seg);
    }
    ...
    public static MemoryAddress writev_nonblocking$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GPollableOutputStreamInterface.writev_nonblocking$VH.get(seg.asSlice(index*sizeof()));
    }
