...
public class _GStaticRecMutex {
    ...
    static final VarHandle depth$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("depth"));
    ...
    public static class unused {
        ...
        static final VarHandle owner$VH = unused$union$LAYOUT.varHandle(PathElement.groupElement("owner"));
        ...
        static final VarHandle dummy$VH = unused$union$LAYOUT.varHandle(PathElement.groupElement("dummy"));
