...
public class _GPtrArray {
    ...
    static final VarHandle pdata$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("pdata"));
    public static VarHandle pdata$VH() {
        return _GPtrArray.pdata$VH;
    }
    public static MemoryAddress pdata$get(MemorySegment seg) {
        return (MemoryAddress)_GPtrArray.pdata$VH.get(seg);
    }
    ...
    public static MemoryAddress pdata$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GPtrArray.pdata$VH.get(seg.asSlice(index*sizeof()));
    }
