...
public class GTestConfig {
    ...
    static final VarHandle test_initialized$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("test_initialized"));
    ...
    static final VarHandle test_quick$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("test_quick"));
    ...
    static final VarHandle test_perf$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("test_perf"));
    ...
    static final VarHandle test_verbose$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("test_verbose"));
    ...
    static final VarHandle test_quiet$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("test_quiet"));
    ...
    static final VarHandle test_undefined$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("test_undefined"));
