...
class constants$514 {
    ...
    static final MethodHandle g_application_release$MH = RuntimeHelper.downcallHandle(
        ...
        constants$514.g_application_release$FUNC, false
    );
    ...
    static final MethodHandle g_application_activate$MH = RuntimeHelper.downcallHandle(
        ...
        constants$514.g_application_activate$FUNC, false
    );
    ...
    static final MethodHandle g_application_open$MH = RuntimeHelper.downcallHandle(
        "g_application_open",
        constants$514.g_application_open$FUNC, false
    );
    ...
    static final MethodHandle g_application_run$MH = RuntimeHelper.downcallHandle(
        "g_application_run",
        constants$514.g_application_run$FUNC, false
    );
    ...
    static final MethodHandle g_application_quit$MH = RuntimeHelper.downcallHandle(
        "g_application_quit",
        constants$514.g_application_quit$FUNC, false
    );
    ...
    static final MethodHandle g_application_get_default$MH = RuntimeHelper.downcallHandle(
        ...
        constants$514.g_application_get_default$FUNC, false
    );
}
