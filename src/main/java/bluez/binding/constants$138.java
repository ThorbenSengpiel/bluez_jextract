...
class constants$138 {
    ...
    static final MethodHandle g_int_hash$MH = RuntimeHelper.downcallHandle(
        "g_int_hash",
        constants$138.g_int_hash$FUNC, false
    );
    ...
    static final MethodHandle g_int64_equal$MH = RuntimeHelper.downcallHandle(
        "g_int64_equal",
        constants$138.g_int64_equal$FUNC, false
    );
    ...
    static final MethodHandle g_int64_hash$MH = RuntimeHelper.downcallHandle(
        "g_int64_hash",
        constants$138.g_int64_hash$FUNC, false
    );
    ...
    static final MethodHandle g_double_equal$MH = RuntimeHelper.downcallHandle(
        "g_double_equal",
        constants$138.g_double_equal$FUNC, false
    );
    ...
    static final MethodHandle g_double_hash$MH = RuntimeHelper.downcallHandle(
        "g_double_hash",
        constants$138.g_double_hash$FUNC, false
    );
    ...
    static final MethodHandle g_direct_hash$MH = RuntimeHelper.downcallHandle(
        "g_direct_hash",
        constants$138.g_direct_hash$FUNC, false
    );
}
