...
class constants$163 {
    ...
    static final MethodHandle g_source_set_funcs$MH = RuntimeHelper.downcallHandle(
        "g_source_set_funcs",
        constants$163.g_source_set_funcs$FUNC, false
    );
    ...
    static final MethodHandle g_source_is_destroyed$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.g_source_is_destroyed$FUNC, false
    );
    ...
    static final MethodHandle g_source_set_name$MH = RuntimeHelper.downcallHandle(
        "g_source_set_name",
        constants$163.g_source_set_name$FUNC, false
    );
    ...
    static final MethodHandle g_source_get_name$MH = RuntimeHelper.downcallHandle(
        "g_source_get_name",
        constants$163.g_source_get_name$FUNC, false
    );
    ...
    static final MethodHandle g_source_set_name_by_id$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.g_source_set_name_by_id$FUNC, false
    );
    ...
    static final MethodHandle g_source_set_ready_time$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.g_source_set_ready_time$FUNC, false
    );
}
