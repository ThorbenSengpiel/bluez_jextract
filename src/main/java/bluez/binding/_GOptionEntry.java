...
public class _GOptionEntry {
    ...
    static final VarHandle long_name$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("long_name"));
    ...
    public static MemoryAddress long_name$get(MemorySegment seg) {
        return (MemoryAddress)_GOptionEntry.long_name$VH.get(seg);
    }
    ...
    public static MemoryAddress long_name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GOptionEntry.long_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle short_name$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("short_name"));
    ...
    static final VarHandle arg$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("arg"));
    ...
    static final VarHandle arg_data$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("arg_data"));
    ...
    public static MemoryAddress arg_data$get(MemorySegment seg) {
        return (MemoryAddress)_GOptionEntry.arg_data$VH.get(seg);
    }
    ...
    public static MemoryAddress arg_data$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GOptionEntry.arg_data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle description$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("description"));
    ...
    public static MemoryAddress description$get(MemorySegment seg) {
        return (MemoryAddress)_GOptionEntry.description$VH.get(seg);
    }
    ...
    public static MemoryAddress description$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GOptionEntry.description$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle arg_description$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("arg_description"));
    ...
    public static MemoryAddress arg_description$get(MemorySegment seg) {
        return (MemoryAddress)_GOptionEntry.arg_description$VH.get(seg);
    }
    ...
    public static MemoryAddress arg_description$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GOptionEntry.arg_description$VH.get(seg.asSlice(index*sizeof()));
    }
