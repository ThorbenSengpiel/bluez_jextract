...
public class stack_t {
    ...
    static final VarHandle ss_sp$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ss_sp"));
    public static VarHandle ss_sp$VH() {
        return stack_t.ss_sp$VH;
    }
    public static MemoryAddress ss_sp$get(MemorySegment seg) {
        return (MemoryAddress)stack_t.ss_sp$VH.get(seg);
    }
    ...
    public static MemoryAddress ss_sp$get(MemorySegment seg, long index) {
        return (MemoryAddress)stack_t.ss_sp$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ss_sp$set(MemorySegment seg, long index, MemoryAddress x) {
        stack_t.ss_sp$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle ss_flags$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ss_flags"));
    ...
    static final VarHandle ss_size$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("ss_size"));
