...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GSocketConnectableIface.enumerate$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
    ...
    static final VarHandle enumerate$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("enumerate"));
    ...
    public static MemoryAddress enumerate$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketConnectableIface.enumerate$VH.get(seg);
    }
    ...
    public static MemoryAddress enumerate$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketConnectableIface.enumerate$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GSocketConnectableIface.proxy_enumerate$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle proxy_enumerate$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("proxy_enumerate"));
    ...
    public static MemoryAddress proxy_enumerate$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketConnectableIface.proxy_enumerate$VH.get(seg);
    }
    ...
    public static MemoryAddress proxy_enumerate$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketConnectableIface.proxy_enumerate$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (Addressable)(MemoryAddress)_GSocketConnectableIface.to_string$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle to_string$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("to_string"));
    ...
    public static MemoryAddress to_string$get(MemorySegment seg) {
        return (MemoryAddress)_GSocketConnectableIface.to_string$VH.get(seg);
    }
    ...
    public static MemoryAddress to_string$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GSocketConnectableIface.to_string$VH.get(seg.asSlice(index*sizeof()));
    }
