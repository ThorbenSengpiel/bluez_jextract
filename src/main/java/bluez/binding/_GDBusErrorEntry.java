...
public class _GDBusErrorEntry {
    ...
    static final VarHandle error_code$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("error_code"));
    ...
    static final VarHandle dbus_error_name$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("dbus_error_name"));
    ...
    public static MemoryAddress dbus_error_name$get(MemorySegment seg) {
        return (MemoryAddress)_GDBusErrorEntry.dbus_error_name$VH.get(seg);
    }
    ...
    public static MemoryAddress dbus_error_name$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GDBusErrorEntry.dbus_error_name$VH.get(seg.asSlice(index*sizeof()));
    }
