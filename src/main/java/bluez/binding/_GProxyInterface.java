...
public class _GProxyInterface {
    ...
    public interface connect {
        ...
        Addressable apply(MemoryAddress _x0, MemoryAddress _x1, MemoryAddress _x2, MemoryAddress _x3, MemoryAddress _x4);
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3, MemoryAddress __x4) -> {
                try {
                    return (Addressable)(MemoryAddress)_GProxyInterface.connect$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3, (Addressable)__x4);
                } catch (Throwable ex$) {
    ...
    static final VarHandle connect$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("connect"));
    ...
    public static MemoryAddress connect$get(MemorySegment seg) {
        return (MemoryAddress)_GProxyInterface.connect$VH.get(seg);
    }
    ...
    public static MemoryAddress connect$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GProxyInterface.connect$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2, MemoryAddress __x3, MemoryAddress __x4, MemoryAddress __x5) -> {
                try {
                    _GProxyInterface.connect_async$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2, (Addressable)__x3, (Addressable)__x4, (Addressable)__x5);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle connect_async$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("connect_async"));
    ...
    public static MemoryAddress connect_async$get(MemorySegment seg) {
        return (MemoryAddress)_GProxyInterface.connect_async$VH.get(seg);
    }
    ...
    public static MemoryAddress connect_async$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GProxyInterface.connect_async$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (Addressable)(MemoryAddress)_GProxyInterface.connect_finish$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle connect_finish$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("connect_finish"));
    ...
    public static MemoryAddress connect_finish$get(MemorySegment seg) {
        return (MemoryAddress)_GProxyInterface.connect_finish$VH.get(seg);
    }
    ...
    public static MemoryAddress connect_finish$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GProxyInterface.connect_finish$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (MemoryAddress __x0) -> {
                try {
                    return (int)_GProxyInterface.supports_hostname$MH.invokeExact(symbol, (Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle supports_hostname$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("supports_hostname"));
    ...
    public static MemoryAddress supports_hostname$get(MemorySegment seg) {
        return (MemoryAddress)_GProxyInterface.supports_hostname$VH.get(seg);
    }
    ...
    public static MemoryAddress supports_hostname$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GProxyInterface.supports_hostname$VH.get(seg.asSlice(index*sizeof()));
    }
