...
return (MemoryAddress __x0, MemoryAddress __x1) -> {
                try {
                    return (Addressable)(MemoryAddress)_GNativeVolumeMonitorClass.get_mount_for_mount_path$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1);
                } catch (Throwable ex$) {
    ...
    static final VarHandle get_mount_for_mount_path$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("get_mount_for_mount_path"));
    ...
    public static MemoryAddress get_mount_for_mount_path$get(MemorySegment seg) {
        return (MemoryAddress)_GNativeVolumeMonitorClass.get_mount_for_mount_path$VH.get(seg);
    }
    ...
    public static MemoryAddress get_mount_for_mount_path$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GNativeVolumeMonitorClass.get_mount_for_mount_path$VH.get(seg.asSlice(index*sizeof()));
    }
