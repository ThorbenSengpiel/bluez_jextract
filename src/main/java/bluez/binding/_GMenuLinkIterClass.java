...
return (MemoryAddress __x0, MemoryAddress __x1, MemoryAddress __x2) -> {
                try {
                    return (int)_GMenuLinkIterClass.get_next$MH.invokeExact(symbol, (Addressable)__x0, (Addressable)__x1, (Addressable)__x2);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress get_next$get(MemorySegment seg) {
        return (MemoryAddress)_GMenuLinkIterClass.get_next$VH.get(seg);
    }
    ...
    public static MemoryAddress get_next$get(MemorySegment seg, long index) {
        return (MemoryAddress)_GMenuLinkIterClass.get_next$VH.get(seg.asSlice(index*sizeof()));
    }
