...
class constants$540 {
    ...
    static final MethodHandle g_async_result_get_source_object$MH = RuntimeHelper.downcallHandle(
        ...
        constants$540.g_async_result_get_source_object$FUNC, false
    );
    ...
    static final MethodHandle g_async_result_legacy_propagate_error$MH = RuntimeHelper.downcallHandle(
        ...
        constants$540.g_async_result_legacy_propagate_error$FUNC, false
    );
    ...
    static final MethodHandle g_async_result_is_tagged$MH = RuntimeHelper.downcallHandle(
        ...
        constants$540.g_async_result_is_tagged$FUNC, false
    );
    ...
    static final MethodHandle g_input_stream_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$540.g_input_stream_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_input_stream_read$MH = RuntimeHelper.downcallHandle(
        "g_input_stream_read",
        constants$540.g_input_stream_read$FUNC, false
    );
    ...
    static final MethodHandle g_input_stream_read_all$MH = RuntimeHelper.downcallHandle(
        ...
        constants$540.g_input_stream_read_all$FUNC, false
    );
}
