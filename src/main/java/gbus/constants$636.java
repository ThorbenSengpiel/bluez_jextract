...
class constants$636 {
    ...
    static final MethodHandle g_dbus_proxy_set_interface_info$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_proxy_set_interface_info$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_proxy_get_cached_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_proxy_get_cached_property$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_proxy_set_cached_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_proxy_set_cached_property$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_proxy_get_cached_property_names$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_proxy_get_cached_property_names$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_proxy_call$MH = RuntimeHelper.downcallHandle(
        "g_dbus_proxy_call",
        constants$636.g_dbus_proxy_call$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_proxy_call_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_proxy_call_finish$FUNC, false
    );
}
