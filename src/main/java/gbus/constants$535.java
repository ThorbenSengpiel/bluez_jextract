...
class constants$535 {
    ...
    static final MethodHandle g_application_bind_busy_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$535.g_application_bind_busy_property$FUNC, false
    );
    ...
    static final MethodHandle g_application_unbind_busy_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$535.g_application_unbind_busy_property$FUNC, false
    );
    ...
    static final MethodHandle g_application_command_line_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$535.g_application_command_line_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_application_command_line_get_arguments$MH = RuntimeHelper.downcallHandle(
        ...
        constants$535.g_application_command_line_get_arguments$FUNC, false
    );
    ...
    static final MethodHandle g_application_command_line_get_options_dict$MH = RuntimeHelper.downcallHandle(
        ...
        constants$535.g_application_command_line_get_options_dict$FUNC, false
    );
    ...
    static final MethodHandle g_application_command_line_get_stdin$MH = RuntimeHelper.downcallHandle(
        ...
        constants$535.g_application_command_line_get_stdin$FUNC, false
    );
}
