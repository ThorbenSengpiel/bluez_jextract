...
class constants$504 {
    ...
    static final MethodHandle g_gtype_get_type$MH = RuntimeHelper.downcallHandle(
        "g_gtype_get_type",
        constants$504.g_gtype_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_gtype$MH = RuntimeHelper.downcallHandle(
        "g_value_set_gtype",
        constants$504.g_value_set_gtype$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_gtype$MH = RuntimeHelper.downcallHandle(
        "g_value_get_gtype",
        constants$504.g_value_get_gtype$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_variant$MH = RuntimeHelper.downcallHandle(
        "g_value_set_variant",
        constants$504.g_value_set_variant$FUNC, false
    );
    ...
    static final MethodHandle g_value_take_variant$MH = RuntimeHelper.downcallHandle(
        ...
        constants$504.g_value_take_variant$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_variant$MH = RuntimeHelper.downcallHandle(
        "g_value_get_variant",
        constants$504.g_value_get_variant$FUNC, false
    );
}
