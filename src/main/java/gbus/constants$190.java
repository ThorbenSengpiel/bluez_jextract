...
class constants$190 {
    ...
    static final MethodHandle g_string_vprintf$MH = RuntimeHelper.downcallHandle(
        "g_string_vprintf",
        constants$190.g_string_vprintf$FUNC, false
    );
    ...
    static final MethodHandle g_string_printf$MH = RuntimeHelper.downcallHandle(
        "g_string_printf",
        constants$190.g_string_printf$FUNC, true
    );
    ...
    static final MethodHandle g_string_append_vprintf$MH = RuntimeHelper.downcallHandle(
        ...
        constants$190.g_string_append_vprintf$FUNC, false
    );
    ...
    static final MethodHandle g_string_append_printf$MH = RuntimeHelper.downcallHandle(
        ...
        constants$190.g_string_append_printf$FUNC, true
    );
