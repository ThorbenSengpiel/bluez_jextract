...
public interface GBaseInitFunc {
    ...
    static NativeSymbol allocate(GBaseInitFunc fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(GBaseInitFunc.class, fi, constants$423.GBaseInitFunc$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)V", scope);
    }
...
return (jdk.incubator.foreign.MemoryAddress x0) -> {
            try {
                constants$423.GBaseInitFunc$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)x0);
            } catch (Throwable ex$) {
