...
class constants$841 {
    ...
    static final MethodHandle g_task_return_boolean$MH = RuntimeHelper.downcallHandle(
        ...
        constants$841.g_task_return_boolean$FUNC, false
    );
    ...
    static final MethodHandle g_task_return_int$MH = RuntimeHelper.downcallHandle(
        "g_task_return_int",
        constants$841.g_task_return_int$FUNC, false
    );
    ...
    static final MethodHandle g_task_return_error$MH = RuntimeHelper.downcallHandle(
        "g_task_return_error",
        constants$841.g_task_return_error$FUNC, false
    );
    ...
    static final MethodHandle g_task_return_new_error$MH = RuntimeHelper.downcallHandle(
        ...
        constants$841.g_task_return_new_error$FUNC, true
    );
    ...
    static final MethodHandle g_task_return_value$MH = RuntimeHelper.downcallHandle(
        "g_task_return_value",
        constants$841.g_task_return_value$FUNC, false
    );
    ...
    static final MethodHandle g_task_return_error_if_cancelled$MH = RuntimeHelper.downcallHandle(
        ...
        constants$841.g_task_return_error_if_cancelled$FUNC, false
    );
}
