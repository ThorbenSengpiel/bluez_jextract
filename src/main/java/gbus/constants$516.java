...
class constants$516 {
    ...
    static final MethodHandle g_action_get_state_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$516.g_action_get_state_type$FUNC, false
    );
    ...
    static final MethodHandle g_action_get_state_hint$MH = RuntimeHelper.downcallHandle(
        ...
        constants$516.g_action_get_state_hint$FUNC, false
    );
    ...
    static final MethodHandle g_action_get_enabled$MH = RuntimeHelper.downcallHandle(
        ...
        constants$516.g_action_get_enabled$FUNC, false
    );
    ...
    static final MethodHandle g_action_get_state$MH = RuntimeHelper.downcallHandle(
        "g_action_get_state",
        constants$516.g_action_get_state$FUNC, false
    );
    ...
    static final MethodHandle g_action_change_state$MH = RuntimeHelper.downcallHandle(
        ...
        constants$516.g_action_change_state$FUNC, false
    );
    ...
    static final MethodHandle g_action_activate$MH = RuntimeHelper.downcallHandle(
        "g_action_activate",
        constants$516.g_action_activate$FUNC, false
    );
}
