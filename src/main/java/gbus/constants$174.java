...
class constants$174 {
    ...
    static final MemorySegment g_unix_fd_source_funcs$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_unix_fd_source_funcs", constants$174.g_unix_fd_source_funcs$LAYOUT);
    ...
    static final MethodHandle g_unicode_script_to_iso15924$MH = RuntimeHelper.downcallHandle(
        ...
        constants$174.g_unicode_script_to_iso15924$FUNC, false
    );
    ...
    static final MethodHandle g_unicode_script_from_iso15924$MH = RuntimeHelper.downcallHandle(
        ...
        constants$174.g_unicode_script_from_iso15924$FUNC, false
    );
    ...
    static final MethodHandle g_unichar_isalnum$MH = RuntimeHelper.downcallHandle(
        "g_unichar_isalnum",
        constants$174.g_unichar_isalnum$FUNC, false
    );
