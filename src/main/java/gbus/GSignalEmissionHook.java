...
public interface GSignalEmissionHook {
    ...
    static NativeSymbol allocate(GSignalEmissionHook fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(GSignalEmissionHook.class, fi, constants$453.GSignalEmissionHook$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;ILjdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)I", scope);
    }
...
return (jdk.incubator.foreign.MemoryAddress x0, int x1, jdk.incubator.foreign.MemoryAddress x2, jdk.incubator.foreign.MemoryAddress x3) -> {
            try {
                return (int)constants$453.GSignalEmissionHook$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)x0, x1, (jdk.incubator.foreign.Addressable)x2, (jdk.incubator.foreign.Addressable)x3);
            } catch (Throwable ex$) {
