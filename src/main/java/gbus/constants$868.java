...
class constants$868 {
    ...
    static final MethodHandle g_volume_eject_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$868.g_volume_eject_finish$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_identifier$MH = RuntimeHelper.downcallHandle(
        ...
        constants$868.g_volume_get_identifier$FUNC, false
    );
    ...
    static final MethodHandle g_volume_enumerate_identifiers$MH = RuntimeHelper.downcallHandle(
        ...
        constants$868.g_volume_enumerate_identifiers$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_activation_root$MH = RuntimeHelper.downcallHandle(
        ...
        constants$868.g_volume_get_activation_root$FUNC, false
    );
    ...
    static final MethodHandle g_volume_eject_with_operation$MH = RuntimeHelper.downcallHandle(
        ...
        constants$868.g_volume_eject_with_operation$FUNC, false
    );
    ...
    static final MethodHandle g_volume_eject_with_operation_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$868.g_volume_eject_with_operation_finish$FUNC, false
    );
}
