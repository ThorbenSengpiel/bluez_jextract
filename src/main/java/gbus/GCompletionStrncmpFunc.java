...
public interface GCompletionStrncmpFunc {
    ...
    static NativeSymbol allocate(GCompletionStrncmpFunc fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(GCompletionStrncmpFunc.class, fi, constants$343.GCompletionStrncmpFunc$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;J)I", scope);
    }
...
return (jdk.incubator.foreign.MemoryAddress x0, jdk.incubator.foreign.MemoryAddress x1, long x2) -> {
            try {
                return (int)constants$343.GCompletionStrncmpFunc$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)x0, (jdk.incubator.foreign.Addressable)x1, x2);
            } catch (Throwable ex$) {
