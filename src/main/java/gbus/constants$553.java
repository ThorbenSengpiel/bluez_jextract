...
class constants$553 {
    ...
    static final MethodHandle g_buffered_output_stream_get_buffer_size$MH = RuntimeHelper.downcallHandle(
        ...
        constants$553.g_buffered_output_stream_get_buffer_size$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_output_stream_set_buffer_size$MH = RuntimeHelper.downcallHandle(
        ...
        constants$553.g_buffered_output_stream_set_buffer_size$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_output_stream_get_auto_grow$MH = RuntimeHelper.downcallHandle(
        ...
        constants$553.g_buffered_output_stream_get_auto_grow$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_output_stream_set_auto_grow$MH = RuntimeHelper.downcallHandle(
        ...
        constants$553.g_buffered_output_stream_set_auto_grow$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_icon_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$553.g_bytes_icon_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_icon_new$MH = RuntimeHelper.downcallHandle(
        "g_bytes_icon_new",
        constants$553.g_bytes_icon_new$FUNC, false
    );
}
