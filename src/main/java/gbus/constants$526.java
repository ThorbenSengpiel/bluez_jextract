...
class constants$526 {
    ...
    static final MethodHandle g_app_info_get_recommended_for_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$526.g_app_info_get_recommended_for_type$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_fallback_for_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$526.g_app_info_get_fallback_for_type$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_reset_type_associations$MH = RuntimeHelper.downcallHandle(
        ...
        constants$526.g_app_info_reset_type_associations$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_default_for_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$526.g_app_info_get_default_for_type$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_get_default_for_uri_scheme$MH = RuntimeHelper.downcallHandle(
        ...
        constants$526.g_app_info_get_default_for_uri_scheme$FUNC, false
    );
    ...
    static final MethodHandle g_app_info_launch_default_for_uri$MH = RuntimeHelper.downcallHandle(
        ...
        constants$526.g_app_info_launch_default_for_uri$FUNC, false
    );
}
