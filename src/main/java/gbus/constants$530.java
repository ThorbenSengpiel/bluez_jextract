...
class constants$530 {
    ...
    static final MethodHandle g_application_get_dbus_object_path$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_application_get_dbus_object_path$FUNC, false
    );
    ...
    static final MethodHandle g_application_get_inactivity_timeout$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_application_get_inactivity_timeout$FUNC, false
    );
    ...
    static final MethodHandle g_application_set_inactivity_timeout$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_application_set_inactivity_timeout$FUNC, false
    );
    ...
    static final MethodHandle g_application_get_flags$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_application_get_flags$FUNC, false
    );
    ...
    static final MethodHandle g_application_set_flags$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_application_set_flags$FUNC, false
    );
    ...
    static final MethodHandle g_application_get_resource_base_path$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_application_get_resource_base_path$FUNC, false
    );
}
