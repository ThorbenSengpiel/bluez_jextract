...
class constants$518 {
    ...
    static final MethodHandle g_action_group_get_action_parameter_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$518.g_action_group_get_action_parameter_type$FUNC, false
    );
    ...
    static final MethodHandle g_action_group_get_action_state_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$518.g_action_group_get_action_state_type$FUNC, false
    );
    ...
    static final MethodHandle g_action_group_get_action_state_hint$MH = RuntimeHelper.downcallHandle(
        ...
        constants$518.g_action_group_get_action_state_hint$FUNC, false
    );
    ...
    static final MethodHandle g_action_group_get_action_enabled$MH = RuntimeHelper.downcallHandle(
        ...
        constants$518.g_action_group_get_action_enabled$FUNC, false
    );
    ...
    static final MethodHandle g_action_group_get_action_state$MH = RuntimeHelper.downcallHandle(
        ...
        constants$518.g_action_group_get_action_state$FUNC, false
    );
    ...
    static final MethodHandle g_action_group_change_action_state$MH = RuntimeHelper.downcallHandle(
        ...
        constants$518.g_action_group_change_action_state$FUNC, false
    );
}
