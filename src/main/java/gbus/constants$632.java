...
class constants$632 {
    ...
    static final MethodHandle g_dbus_object_proxy_get_connection$MH = RuntimeHelper.downcallHandle(
        ...
        constants$632.g_dbus_object_proxy_get_connection$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_object_skeleton_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$632.g_dbus_object_skeleton_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_object_skeleton_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$632.g_dbus_object_skeleton_new$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_object_skeleton_flush$MH = RuntimeHelper.downcallHandle(
        ...
        constants$632.g_dbus_object_skeleton_flush$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_object_skeleton_add_interface$MH = RuntimeHelper.downcallHandle(
        ...
        constants$632.g_dbus_object_skeleton_add_interface$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_object_skeleton_remove_interface$MH = RuntimeHelper.downcallHandle(
        ...
        constants$632.g_dbus_object_skeleton_remove_interface$FUNC, false
    );
}
