...
class constants$537 {
    ...
    static final MethodHandle g_application_command_line_get_exit_status$MH = RuntimeHelper.downcallHandle(
        ...
        constants$537.g_application_command_line_get_exit_status$FUNC, false
    );
    ...
    static final MethodHandle g_application_command_line_set_exit_status$MH = RuntimeHelper.downcallHandle(
        ...
        constants$537.g_application_command_line_set_exit_status$FUNC, false
    );
    ...
    static final MethodHandle g_application_command_line_get_platform_data$MH = RuntimeHelper.downcallHandle(
        ...
        constants$537.g_application_command_line_get_platform_data$FUNC, false
    );
    ...
    static final MethodHandle g_application_command_line_create_file_for_arg$MH = RuntimeHelper.downcallHandle(
        ...
        constants$537.g_application_command_line_create_file_for_arg$FUNC, false
    );
    ...
    static final MethodHandle g_initable_get_type$MH = RuntimeHelper.downcallHandle(
        "g_initable_get_type",
        constants$537.g_initable_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_initable_init$MH = RuntimeHelper.downcallHandle(
        "g_initable_init",
        constants$537.g_initable_init$FUNC, false
    );
}
