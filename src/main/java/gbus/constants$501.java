...
class constants$501 {
    ...
    static final MethodHandle g_value_get_long$MH = RuntimeHelper.downcallHandle(
        "g_value_get_long",
        constants$501.g_value_get_long$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_ulong$MH = RuntimeHelper.downcallHandle(
        "g_value_set_ulong",
        constants$501.g_value_set_ulong$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_ulong$MH = RuntimeHelper.downcallHandle(
        "g_value_get_ulong",
        constants$501.g_value_get_ulong$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_int64$MH = RuntimeHelper.downcallHandle(
        "g_value_set_int64",
        constants$501.g_value_set_int64$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_int64$MH = RuntimeHelper.downcallHandle(
        "g_value_get_int64",
        constants$501.g_value_get_int64$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_uint64$MH = RuntimeHelper.downcallHandle(
        "g_value_set_uint64",
        constants$501.g_value_set_uint64$FUNC, false
    );
}
