...
return (jdk.incubator.foreign.MemoryAddress x0) -> {
                try {
                    return (int)_GTypeModuleClass.load$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)x0);
                } catch (Throwable ex$) {
...
return (jdk.incubator.foreign.MemoryAddress x0) -> {
                try {
                    _GTypeModuleClass.unload$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
