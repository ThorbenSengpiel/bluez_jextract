...
class constants$422 {
    ...
    static final MethodHandle g_type_children$MH = RuntimeHelper.downcallHandle(
        "g_type_children",
        constants$422.g_type_children$FUNC, false
    );
    ...
    static final MethodHandle g_type_interfaces$MH = RuntimeHelper.downcallHandle(
        "g_type_interfaces",
        constants$422.g_type_interfaces$FUNC, false
    );
    ...
    static final MethodHandle g_type_set_qdata$MH = RuntimeHelper.downcallHandle(
        "g_type_set_qdata",
        constants$422.g_type_set_qdata$FUNC, false
    );
    ...
    static final MethodHandle g_type_get_qdata$MH = RuntimeHelper.downcallHandle(
        "g_type_get_qdata",
        constants$422.g_type_get_qdata$FUNC, false
    );
    ...
    static final MethodHandle g_type_query$MH = RuntimeHelper.downcallHandle(
        "g_type_query",
        constants$422.g_type_query$FUNC, false
    );
    ...
    static final MethodHandle g_type_get_instance_count$MH = RuntimeHelper.downcallHandle(
        ...
        constants$422.g_type_get_instance_count$FUNC, false
    );
}
