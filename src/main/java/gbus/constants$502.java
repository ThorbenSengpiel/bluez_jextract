...
class constants$502 {
    ...
    static final MethodHandle g_value_get_uint64$MH = RuntimeHelper.downcallHandle(
        "g_value_get_uint64",
        constants$502.g_value_get_uint64$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_float$MH = RuntimeHelper.downcallHandle(
        "g_value_set_float",
        constants$502.g_value_set_float$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_float$MH = RuntimeHelper.downcallHandle(
        "g_value_get_float",
        constants$502.g_value_get_float$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_double$MH = RuntimeHelper.downcallHandle(
        "g_value_set_double",
        constants$502.g_value_set_double$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_double$MH = RuntimeHelper.downcallHandle(
        "g_value_get_double",
        constants$502.g_value_get_double$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_string$MH = RuntimeHelper.downcallHandle(
        "g_value_set_string",
        constants$502.g_value_set_string$FUNC, false
    );
}
