...
class constants$545 {
    ...
    static final MethodHandle g_buffered_input_stream_get_buffer_size$MH = RuntimeHelper.downcallHandle(
        ...
        constants$545.g_buffered_input_stream_get_buffer_size$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_input_stream_set_buffer_size$MH = RuntimeHelper.downcallHandle(
        ...
        constants$545.g_buffered_input_stream_set_buffer_size$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_input_stream_get_available$MH = RuntimeHelper.downcallHandle(
        ...
        constants$545.g_buffered_input_stream_get_available$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_input_stream_peek$MH = RuntimeHelper.downcallHandle(
        ...
        constants$545.g_buffered_input_stream_peek$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_input_stream_peek_buffer$MH = RuntimeHelper.downcallHandle(
        ...
        constants$545.g_buffered_input_stream_peek_buffer$FUNC, false
    );
    ...
    static final MethodHandle g_buffered_input_stream_fill$MH = RuntimeHelper.downcallHandle(
        ...
        constants$545.g_buffered_input_stream_fill$FUNC, false
    );
}
