...
class constants$499 {
    ...
    static final MethodHandle g_value_get_char$MH = RuntimeHelper.downcallHandle(
        "g_value_get_char",
        constants$499.g_value_get_char$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_schar$MH = RuntimeHelper.downcallHandle(
        "g_value_set_schar",
        constants$499.g_value_set_schar$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_schar$MH = RuntimeHelper.downcallHandle(
        "g_value_get_schar",
        constants$499.g_value_get_schar$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_uchar$MH = RuntimeHelper.downcallHandle(
        "g_value_set_uchar",
        constants$499.g_value_set_uchar$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_uchar$MH = RuntimeHelper.downcallHandle(
        "g_value_get_uchar",
        constants$499.g_value_get_uchar$FUNC, false
    );
    ...
    static final MethodHandle g_value_set_boolean$MH = RuntimeHelper.downcallHandle(
        "g_value_set_boolean",
        constants$499.g_value_set_boolean$FUNC, false
    );
}
