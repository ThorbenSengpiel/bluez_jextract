...
class constants$492 {
    ...
    static final MethodHandle g_param_spec_variant$MH = RuntimeHelper.downcallHandle(
        ...
        constants$492.g_param_spec_variant$FUNC, false
    );
    static final  OfAddress g_param_spec_types$LAYOUT = Constants$root.C_POINTER$LAYOUT;
    static final VarHandle g_param_spec_types$VH = constants$492.g_param_spec_types$LAYOUT.varHandle();
    static final MemorySegment g_param_spec_types$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_param_spec_types", constants$492.g_param_spec_types$LAYOUT);
    ...
    static final MethodHandle g_source_set_closure$MH = RuntimeHelper.downcallHandle(
        ...
        constants$492.g_source_set_closure$FUNC, false
    );
    ...
    static final MethodHandle g_source_set_dummy_callback$MH = RuntimeHelper.downcallHandle(
        ...
        constants$492.g_source_set_dummy_callback$FUNC, false
    );
    ...
    static final MethodHandle glib_autoptr_clear_GTypeModule$MH = RuntimeHelper.downcallHandle(
        ...
        constants$492.glib_autoptr_clear_GTypeModule$FUNC, false
    );
    ...
    static final MethodHandle glib_autoptr_cleanup_GTypeModule$MH = RuntimeHelper.downcallHandle(
        ...
        constants$492.glib_autoptr_cleanup_GTypeModule$FUNC, false
    );
}
