...
class constants$783 {
    ...
    static final MethodHandle g_seekable_tell$MH = RuntimeHelper.downcallHandle(
        "g_seekable_tell",
        constants$783.g_seekable_tell$FUNC, false
    );
    ...
    static final MethodHandle g_seekable_can_seek$MH = RuntimeHelper.downcallHandle(
        "g_seekable_can_seek",
        constants$783.g_seekable_can_seek$FUNC, false
    );
    ...
    static final MethodHandle g_seekable_seek$MH = RuntimeHelper.downcallHandle(
        "g_seekable_seek",
        constants$783.g_seekable_seek$FUNC, false
    );
    ...
    static final MethodHandle g_seekable_can_truncate$MH = RuntimeHelper.downcallHandle(
        ...
        constants$783.g_seekable_can_truncate$FUNC, false
    );
    ...
    static final MethodHandle g_seekable_truncate$MH = RuntimeHelper.downcallHandle(
        "g_seekable_truncate",
        constants$783.g_seekable_truncate$FUNC, false
    );
    ...
    static final MethodHandle g_settings_schema_source_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$783.g_settings_schema_source_get_type$FUNC, false
    );
}
